...
layers = [
    ...
    {"name": "unhold_head_spike",                "layer": "top", "min": 1, "max": 1, "value" : 1000, "con" : 100, "stam" : -9, "vis" : -3,  "hair" : "false", "beard" :"true" },
...
titles = {
    ...
    "unhold_head_chain"     :       "Unhold Head Chain",
    "unhold_head_spike"     :       "Unhold head Spike",
...
descriptions = {
    ...
    "chain_attachment" :         "A piece of mail used for hanging over the mouth and nose",
    "cult_hood" :                "A hood used in cultist ceremonies",
    "eyemask" :                  "A metal mask covering the eyes and nose from blows",
    "facemask" :                 "A metal faceplate in the shape of a mask",
    ...
    "faceplate_full" :           "A very well crafted full faceplate",
    "faceplate_full_01_named" :  "An exceptionally well crafted faceplate of high worksmanship",
    "faceplate_gold" :           "A gilded faceplate of excellent quality",
    "faceplate_long" :           "A long faceplate",
    "faceplate_pointed" :        "A long nosed faceplate designed to deflect glancing blows",
    "faceplate_raised" :         "A faceplate raised up to give more air and vision",
    "faceplate_short" :          "A short squat faceplate",
    "faceplate_snub_nose" :      "A round nosed faceplate",
    "faceplate_winged" :         "A glorious faceplate formed into the shape of wings",
    "goblin_gillie" :            "Helmet camouflague used by goblin ambushers",
    "goblin_leaves" :            "A set of leaves used by goblins to disguise themselves",
    "headband_nose" :            "A rough leather headband with a small nose protection",
    "headband_side" :            "A rugged leather headband",
    "leather_hood_barb" :        "The crude padded leather hood of a barbarian, it is heavy and surprisingly protective",
    "nose_plate" :               "A strip of metal tied on with a leather band, used for protecting the face from frontal blows",
    "unhold_head_chain"     :     "The chain used by barbarian beastmasters for controlling unholds.",
    "unhold_head_spike"     :     "The heavy spiked armor used by barbarian unholds",
    ...
    "southern_headband" :    "A beautiful headband from southern lands where dyes are plentiful",
    "southern_patterned_headband" :   "A gorgeous patterned headband from southern merchants",
    "southern_patterned_headwrap" :   "A beautiful patterned headwrap from the south",
    "southern_top_tail" :    "A decorative tail made of desert animal hair",
    "southern_turban_open" : "A turban with open face",
    ...
    "southern_noble_crown" : "The crown of a southern vizier",
    "southern_noble_hat" : "The hat of a southern vizier",
    "southern_noble_turban" : "The turban of a southern vizier",
