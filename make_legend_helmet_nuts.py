...
descriptions = {
    "barb_chain_scarf" :     "A simple chain scarf, offering basic neck protection.",
    "chain_hood" :          "A basic chain coif, offering moderate protection.",
    "chain_hood_full" :     "A full layer of chain, a bit uncomfortable but offers good protection.",
    "chain_scarf" :         "A simple chain scarf which offers moderate neck protection.",
    "cloth_scarf" :         "A comfortable scarf which offers good protection from the weather.",
    "goblin_scarf" :        "A very light scarf, which offers little protection.",
    "leather_hood" :        "A full hood of leather, offers a good layer between metal and the head.",
    "padded_hood" :         "A thick felt layer, offering a comfortable solution for protection.",
    "patched_hood" :         "Patched Hood",
    "rotten_chain_scarf" :   "A rusty mail coif that still offers good protection - it leaves horrible stains though.",
    "simple_hood" :          "Simple Hood",
    "padded_cap" :           "Padded Cap",
    ...
    "norman_helm" :                         "A commonly used helmet with a nose guard which offers some protection.",
    "orc_double_helm" :                     "Orc Double Helm",
    "orc_great_helm" :                      "Orc Great Helm",
    "orc_horn_mask" :                       "A rough mask made of leather, with horns protruding from the front.",
    "orc_leather_mask" :                    "A rough leather mask, patched together with various skins and bones.",
    "orc_metal_mask" :                      "An orc mask made of metal, heavy and hard to wear.",
    "orc_strapped_helm" :                   "A heavy loose-fitting orc helmet, with various plates strapped across it.",
    ...
    "faction_helmet" :       "A closed metal helm with breathing holes and intricate decoration ontop. Great in the way of protection, a piece of art to behold, but hard to breathe in and limiting the field of view.",
