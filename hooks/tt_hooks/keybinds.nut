...
::ModJimmysTooltips.Mod.Keybinds.addSQKeybind("updateTooltip", "z", ::MSU.Key.State.Tactical, function() {
...
::ModJimmysTooltips.Mod.Keybinds.addSQKeybind("resetTooltip", "z", ::MSU.Key.State.Tactical, function() {
