...
::ModJimmysTooltips.Mod.Keybinds.addSQKeybind("updateTooltip", "L", ::MSU.Key.State.Tactical, function() {
...
::ModJimmysTooltips.Mod.Keybinds.addSQKeybind("resetTooltip", "L", ::MSU.Key.State.Tactical, function() {
