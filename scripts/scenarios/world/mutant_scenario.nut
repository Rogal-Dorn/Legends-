this.mutant_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	m = {},
	function create()
	{
		this.m.ID = "scenario.mutant";
		this.m.Name = "Mutant";
	...
	function onSpawnAssets()
	{
		...
		bros[0].getBackground().m.RawDescription = "A relic from another time. You are a mutant, your body transformed for one task. Hunting monsters.";
		bros[0].getBackground().buildDescription(true);
		bros[0].setTitle("the Mutant");
