this.legends_debug_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		local helmets = [
			...
			"helm/legend_helmet_two_piece_barbute_named",
			"helm/legend_helmet_two_piece_barbute",
			"helm/legend_helmet_fluted_kettle_helm_named",
			...
			"vanity/legend_helmet_executioner_hood",
