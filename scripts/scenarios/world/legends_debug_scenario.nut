this.legends_debug_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		local helmets = [
			"hood/barb_chain_scarf",
			"hood/chain_hood",
			"hood/chain_hood_full",
			"hood/chain_scarf",
			"hood/cloth_scarf",
			"hood/goblin_scarf",
			"hood/leather_hood",
			"hood/padded_hood",
			"hood/patched_hood",
			"hood/rotten_chain_scarf",
			"hood/simple_hood",
			"helm/ancient_beard_mask",
			"helm/ancient_conic_helm",
			"helm/ancient_crested",
			"helm/ancient_crown",
			"helm/ancient_dome",
			"helm/ancient_dome_tailed",
			"helm/ancient_face_helm",
			"helm/ancient_face_plate",
			"helm/ancient_kettle",
			"helm/ancient_legionaire",
			"helm/ancient_lion_mask",
			"helm/ancient_mask",
			"helm/ancient_side_hawk",
			"helm/ancient_tailed_conic_helm",
			"helm/barbute",
			"helm/basinet",
			"helm/carthaginian",
			"helm/cloth_bandana",
			"helm/conic_helm",
			"helm/crude_cylinder_helm",
			"helm/crude_metal_helm",
			"helm/crude_skull_helm",
			"helm/flat_top_face_plate",
			"helm/flat_top_helm",
			"helm/goblin_chain_helm",
			"helm/goblin_leaf_helm",
			"helm/goblin_leather_helm",
			"helm/goblin_leather_mask",
			"helm/gobline_spiked_helm",
			"helm/golden_helm",
			"helm/great_helm",
			"helm/heavy_plate_helm",
			"helm/heavy_spiked_helm",
			"helm/horsetail",
			"helm/kettle_helm",
			"helm/leather_cap",
			"helm/legend_ancient_gladiator",
			"helm/legend_ancient_legionaire_restored",
			"helm/legend_frogmouth",
			"helm/nordic_helm",
			"helm/norman_helm",
			"helm/orc_double_helm",
			"helm/orc_great_helm",
			"helm/orc_horn_mask",
			"helm/orc_leather_mask",
			"helm/orc_metal_mask",
			"helm/orc_strapped_helm",
			"helm/padded_cap",
			"helm/rotten_flat_top_face_mask",
			"helm/rotten_great_helm",
			"helm/sallet",
			"helm/skin_helm",
			"helm/stag_helm",
			"helm/swan_helm",
			...
			"top/faceplate_gold",
			"top/faceplate_long",
			"top/faceplate_pointed",
			"top/faceplate_raised",
			"top/faceplate_short",
			"top/faceplate_snub_nose",
			"top/faceplate_winged",
			"top/goblin_gillie",
			"top/goblin_leaves",
			"top/headband_nose",
			"top/headband_side",
			"top/hood_cloth_round",
			"top/hood_cloth_square",
			"top/hood_cloth_wide",
			"top/leather_hood_barb",
			"top/nose_plate",
			"vanity/antler",
			"vanity/bear_head",
			"vanity/beret",
			"vanity/bull_horns",
			"vanity/cloth_long_hood",
			"vanity/crown",
			"vanity/faction_helmet",
			"vanity/faction_helmet_2",
			"vanity/feather_band",
			"vanity/feathered_hat",
			"vanity/goat_horns",
			"vanity/headband",
			"vanity/horn_decorations",
			"vanity/hunter_cap",
			"vanity/impaled_head",
			"vanity/jester_hat",
			"vanity/metal_bird",
			"vanity/noble_buckle",
			"vanity/noble_feather",
			"vanity/noble_floppy_hat",
			"vanity/noble_hat",
			"vanity/noble_hood",
			"vanity/olivebranch",
			"vanity/orc_bones",
			...
			"vanity/straw_hat",
			"vanity/top_feather",
			"vanity/witchhunter_helm",
			"vanity/wizard_cowl",
			"vanity/wolf_helm",
			"vanity_lower/back_crest",
			"vanity_lower/back_feathers",
			"vanity_lower/feather_crest",
			"vanity_lower/knotted_tail",
			"vanity_lower/orc_tail",
			"vanity_lower/wings"
		]
