this.legends_debug_scenario <- this.inherit("scripts/scenarios/world/starting_scenario", {
	...
	function onSpawnAssets()
	{
		...
		local helmets = [
			...
			"helm/legend_helmet_ancient_crown",
			...
			"helm/legend_helmet_leather_cap",
			...
			"helm/legend_helmet_vampire_crown",
			...
			"vanity/legend_helmet_cloth_long_hood",
			...
			"vanity/legend_helmet_olivebranch",
