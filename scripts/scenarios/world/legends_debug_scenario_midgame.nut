this.legends_debug_scenario_midgame <- this.inherit("scripts/scenarios/world/starting_scenario", {
	m = {},
	function create()
	{
		this.m.ID = "scenario.legends_debug_party_midgame";
		this.m.Name = "(Developer Debug - midgame)";
		this.m.Description = "[p=c][img]gfx/ui/events/event_80.png[/img][/p]Debug mode for legends developers. Start with a full party equipped with mid-game equipment for balance testing.";
		this.m.Difficulty = 2;
		this.m.Order = 99;
	...
	function onSpawnAssets()
	{
		...
		for( local i = 0; i < partysize; i = ++i )
		{
			...
			bro.getBaseProperties().Hitpoints = 80;
			bro.getBaseProperties().MeleeSkill = 75;
