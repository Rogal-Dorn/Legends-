this.scenario_line_battle_nobles <- this.inherit("scripts/scenarios/tactical/scenario_template", {
	...
	function initEntities()
	{
		...
		entity.setFaction(this.Const.Faction.NobleHouse);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/humans/legne_noble_fencer", 13, 13, 15, 15);
		entity.setFaction(this.Const.Faction.NobleHouse);
		entity.assignRandomEquipment();
		...
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/humans/noble_archer", x, x, 17, 17);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		x = x + 1;
		...
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
		entity = this.spawnEntity("scripts/entity/tactical/humans/noble_arbalester", x, x, 14, 14);
		entity.setFaction(this.Const.Faction.Orcs);
		entity.assignRandomEquipment();
	}
