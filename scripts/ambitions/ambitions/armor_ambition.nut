this.armor_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.UIText = "Have 3 pieces of both armor and helmets with 230+ durability";
		this.m.TooltipText = "Have 3 pieces of body armor, and 3 helmets, each with 230 durability or more. Whether you buy them or loot them off of the battlefield, they will protect your men equally good.";
