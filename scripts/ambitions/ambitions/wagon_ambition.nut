this.wagon_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function onReward()
	{
		...
		this.World.Assets.getStash().resize(this.World.Assets.getStash().getCapacity() + 26);
		this.m.SuccessList.push({
			id = 10,
