this.defeat_beasts_ambition <- this.inherit("scripts/ambitions/ambition", {
	...
	function create()
	{
		...
		this.m.UIText = "Defeat packs of beasts";
		this.m.TooltipText = "Defeat 5 packs of beasts in battle, such as Direwolves or Nachzehrers, whether as part of a contract or by seeking them out on your own.";
