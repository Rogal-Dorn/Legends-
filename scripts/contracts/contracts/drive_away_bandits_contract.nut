this.drive_away_bandits_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Name = "Drive away brigands";
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			Options = [
				...
				{
					Text = "You\'ll have to pay with blood if you want it so badly.",
					function getResult()
					{
