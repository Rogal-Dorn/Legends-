this.restore_location_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Description = "Local lords have a spare work party and want to restore the nearby rundown location, clear the location out and escort the work party.";
