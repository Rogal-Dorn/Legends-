this.defend_holy_site_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Description = "Scouts report that the southerners are gathering to take the holysite, local lords want you to get to the holysite first and deffend it from the southern menace.";
