this.legend_hunting_demon_alps_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Description = "Your kind has heard of nightmares plaguing locals but something about these reports is jsut downright demonic, set up camp and end the citys nightmares.";
