this.legend_hunting_greenwood_schrats_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Name = "The Heart of the Woods";
	...
	function createScreens()
	{
		...
		this.m.Screens.push({
			...
			Text = "[img]gfx/ui/events/event_107.png[/img]{The undergrowth has grown thick and hard to walk through, a tangle of roots, vines and branches. Your men hack through the wood, sending shudders reverberating through the forest and birds squaking off into the air. Suddenly one of branches rears back as you strike it in half. The leafy bough pulls away as a nearby trunk turns to face you, revealing a glowing face made from the gnarled burls of wood. The eyes seem to dance with a playful green fire and its other branches turn towards you, ready to strike. }",
			Image = "",
			List = [],
			Options = [
				{
