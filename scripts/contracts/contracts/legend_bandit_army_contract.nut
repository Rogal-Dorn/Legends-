this.legend_bandit_army_contract <- this.inherit("scripts/contracts/contract", {
	...
	function start()
	{
		...
		local banditcamp = this.Flags.set("isContractLocation", true); //prevents additional patrols (banditroamers+ambushers) being generated and diluting garrison strength
