this.return_item_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Description = "Brigands have stolen a local artifact and the city is in outrage, follow their tracks, leave no survivors, and return the cities relic.";
