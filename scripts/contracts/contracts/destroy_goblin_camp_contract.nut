			...
			function onDestinationAttacked( _dest, _isPlayerAttacking = true )
			{
				if (this.Flags.get("IsAmbush"))
				{
					...
					else
					{
						...
						this.Const.World.Common.addUnitsToCombat(p.Entities, this.Const.World.Spawn.GoblinRaiders, 50 * this.Contract.getReputationToDifficultyMult(), this.Contract.m.Destination.getFaction());
			...
			Options = [
				{
					...
					function getResult()
					{
						...
						this.Const.World.Common.addUnitsToCombat(p.Entities, this.Const.World.Spawn.Noble, 140 * this.Contract.getReputationToDifficultyMult(), this.Contract.getFaction());
