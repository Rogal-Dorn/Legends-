this.raid_caravan_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Description = "A noble lord has recieved a caravan route of an enemy house and is looking to hire 'brigands' to raid it, intercept the caravan and let nobody escape.";
