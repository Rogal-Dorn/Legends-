this.legend_hunting_rock_unholds_contract <- this.inherit("scripts/contracts/contract", {
	...
	function create()
	{
		...
		this.m.Name = "Hunting a Mountain";
