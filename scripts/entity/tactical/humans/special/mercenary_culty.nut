this.mercenary_culty <- this.inherit("scripts/entity/tactical/humans/special/mercenary_custom", {
	m = {},
	function create()
	{
		this.m.Type = this.Const.EntityType.Mercenary;
		this.m.BloodType = this.Const.BloodType.Red;
		this.m.XP = this.Const.Tactical.Actor.Culty.XP;
		this.human.create();
		this.m.Faces = this.Const.Faces.AllMale;
		this.m.Hairs = this.Const.Hair.AllMale;
		this.m.HairColors = this.Const.HairColors.All;
        this.m.AIAgent = this.new("scripts/ai/tactical/agents/mercenary_culty_melee_agent");
	...
	function onInit()
	{
		...
		b.setValues(this.Const.Tactical.Actor.Culty);
	...
	function assignRandomEquipment()
	{
        ...
        {
            local armor = this.new("scripts/items/legend_armor/cloth/legend_sackcloth_tattered");
