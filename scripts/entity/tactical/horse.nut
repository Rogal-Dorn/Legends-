this.wardog <- this.inherit("scripts/entity/tactical/actor", {
	...
	function create()
	{
		this.m.Type = this.Const.EntityType.Horse;
		...
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/horse_agent");
		this.m.AIAgent.setActor(this);
	}

	function setVariant( _v )
	{
		this.m.Items.getAppearance().Body = "horse_0" + _v + "_bridled";
		this.getSprite("body").setBrush("horse_0" + _v + "_bridled");
		this.setDirty(true);
	}
	...
	function onInit()
	{
		...
		this.m.Items.getAppearance().Body = "horse_0" + variant + "_bridled";
