this.legend_manticore_tail <- this.inherit("scripts/entity/tactical/actor", {
	m = {
		Body = null,
		Racial = null
	},
	...
	{
		return "manticore_tail_orientation";
	}
	...
	function create()
	{
		...
		this.m.AIAgent = this.new("scripts/ai/tactical/agents/legend_manticore_tail_agent");
	...
	function onDeath( _killer, _skill, _tile, _fatalityType )
	{
		if (_tile != null)
		{
			...
			decal = _tile.spawnDetail("bust_manticore_tail_01_dead", this.Const.Tactical.DetailFlag.Corpse, flip);
	...
	function onInit()
	{
		...
		body.setBrush("bust_manticore_tail_0" + this.Math.rand(1, 1));
		...
		injury.setBrush("bust_manticore_tail_01_injured");
		local body_blood = this.addSprite("body_blood");
		this.addDefaultStatusSprites();
		this.getSprite("status_rooted").Scale = 0.54;
		this.setSpriteOffset("status_rooted", this.createVec(0, 0));
		this.m.Skills.add(this.new("scripts/skills/actives/legend_manticore_sting"));
		this.m.Skills.add(this.new("scripts/skills/actives/legend_manticore_barrage"));
