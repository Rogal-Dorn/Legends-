this.large_tundra_fort <- this.inherit("scripts/entity/world/settlement", {
	...
	function onBuild( _settings )
	{
		...
		if ( _settings.StackCitadels)
		{
			...
			this.buildAttachedLocation(1, "scripts/entity/world/attached_location/pig_farm_location", ALL, []);
			this.buildAttachedLocation(1, "scripts/entity/world/attached_location/brewery_location", ALL, []);
			return;
		}
