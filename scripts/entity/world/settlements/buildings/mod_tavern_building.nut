this.mod_tavern_building <- this.inherit("scripts/entity/world/settlements/buildings/building", {
	//changed to use crowd sprite, free drinks
	m = {
		RumorsGiven = 0,
		RoundsGiven = 0,
		LastRumorTime = 0.0,
	...
	function create()
	{
		...
		this.m.ID = "building.mod_tavern";
		this.m.Name = "Tavern";
		this.m.UIImage = "ui/settlements/crowd_03";
		this.m.UIImageNight = "ui/settlements/crowd_03";
