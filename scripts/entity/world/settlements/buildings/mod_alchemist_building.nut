this.mod_alchemist_building <- this.inherit("scripts/entity/world/settlements/buildings/building", {
	//adds exp potions to shop. Will probably get removed once I have upgraded temple
	m = {
		Stash = null
	},
	function getStash()
	...
	function create()
	{
		...
		this.m.ID = "building.mod_alchemist";
