this.player_party <- this.inherit("scripts/entity/world/party", {
	...
	function onUpdate()
	{
		...
		{
			if (bro.getSkills().hasSkill("perk.vazl_vala_inscribe_weapon") || bro.getSkills().hasSkill("perk.vazl_vala_inscribe_helmet") || bro.getSkills().hasSkill("perk.vazl_vala_inscribe_armor") || bro.getSkills().hasSkill("perk.vazl_vala_inscribe_shield"))
			{
