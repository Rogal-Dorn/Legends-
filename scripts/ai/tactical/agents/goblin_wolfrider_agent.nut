this.goblin_wolfrider_agent <- this.inherit("scripts/ai/tactical/agent", {
	...
	function create()
	{
		...
		this.m.Properties.TargetPriorityHitchanceMult = 0.400000006;
		this.m.Properties.TargetPriorityHitpointsMult = 0.200000003;
		this.m.Properties.TargetPriorityRandomMult = 0.0;
		this.m.Properties.TargetPriorityDamageMult = 0.400000006;
		...
		this.m.Properties.OverallDefensivenessMult = 0.899999976;
		this.m.Properties.OverallFormationMult = 0.100000001;
