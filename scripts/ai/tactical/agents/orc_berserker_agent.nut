this.orc_berserker_agent <- this.inherit("scripts/ai/tactical/agent", {
	...
	function create()
	{
		...
		this.m.Properties.TargetPriorityFleeingMult = 0.800000012;
		...
		this.m.Properties.OverallDefensivenessMult = 0.330000013;
		...
		this.m.Properties.EngageAgainstSpearwallMult = 1.10000002;
