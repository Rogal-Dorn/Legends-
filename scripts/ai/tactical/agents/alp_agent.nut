this.alp_agent <- this.inherit("scripts/ai/tactical/agent", {
	...
	function create()
	{
		...
		this.m.Properties.TargetPriorityHitpointsMult = 0.400000006;
		this.m.Properties.TargetPriorityRandomMult = 0.0;
		this.m.Properties.TargetPriorityDamageMult = 0.0;
		this.m.Properties.TargetPriorityFleeingMult = 0.100000001;
		...
		this.m.Properties.TargetPriorityBraveryMult = 0.600000024;
		this.m.Properties.OverallDefensivenessMult = 0.100000001;
