...
this.sato_find_slave_after_battle_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		local NomadSouthernerText3 = "You enter one of the nomads tents and are greeted with a most curious sight. A half naked man, wide-eyed in surprise, stands frozen over the body of a dead nomad. A leg of lamb hangs from his mouth by a sinewy thread, the meat dangerously close to falling. The man glances down his nose at it, then at you, then at the nomad corpse, then at his precarious meal again. You tell him he\'d better grab his food before he wastes it, and he practically melts in relief as he complies. You gather that the nomads captured the man and made him their slave, and he attempted to use the confusion of the battle to escape - he had just killed his guard and was grabbing provisions when you walked in. You think so, anyhow - mouthfuls of lamb did his abilities as a storyteller no favors.\n\nRegardless of his table manners, it remains clear that the man is if nothing else able to kill for survival. Might his skills be put to better use in the %companyname%?"
		this.m.Screens.push({
			ID = "Nomads",
			...
			function start( _event )
			{
				...
				local text1 = "{A conscript in one of the many regiments of the south, %name% was always proud of his work. Despite the mandatory nature of his service, he always felt that protecting the holy city-state was the mandate of the Gilder more than the Vizier. His devotion went unnoticed by his officers, however, who sent the man on a doomed scouting mission to ferret out nomads hiding in the ocean of sand outside the city. | %name% used to be a treasure hunter, plumbing the depths of the myriad ruins and detritus of the old empire buried in the sands. One day a sandstorm blew him off-course while hunting for a famed library of old. Not to be deterred, he pressed on after the storm died down, determined to not let his search be in vain. | %name% was a manhunter in a past life, ironically enough. He made a comfortable living hunting down deserters, convicts, and escaped slaves, until one day he strayed too deep into the desert while hunting a quarry.}";
				local text2 = "{It was the nomads who proved the more able hunters, however, catching the man by surprise and knocking him out in one fell swoop. | Isolated and unprepared to go so far afield, however, the man collapsed under the burning sun. When he awoke, he was already the nomad\'s captive. | If the man thought himself a hunter, however, the nomads that suddenly appeared all around him cured him of the notion. He certainly thought himself prey as they subdued him and bound his hands.}";
