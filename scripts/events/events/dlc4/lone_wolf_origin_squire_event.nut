		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Dude.setStartValuesEx([
					"lonewolf_squire_background"
				]);
				_event.m.Dude.getBackground().m.RawDescription = "You met %name% in " + _event.m.Town.getName() + " where they volunteered to be your squire. They probably had no idea what he was getting into back then but is still good for cleaning and cooking all the same.";
