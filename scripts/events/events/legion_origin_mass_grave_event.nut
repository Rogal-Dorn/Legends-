	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			function start( _event )
			{
				...
				_event.m.Dude.m.Skills.add(this.new("scripts/skills/racial/skeleton_racial"));
				_event.m.Dude.m.Skills.add(this.new("scripts/skills/injury_permanent/legend_fleshless"));
