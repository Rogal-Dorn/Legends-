this.legend_lonewolf_companion_ranged_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({
			ID = "A",
			Text = "[img]gfx/ui/events/event_36.png[/img]{A figure comes into sight, sitting on a low rock and carefully sharpening their weapon and patching any holes in their armour. Strangely enough, they speak first.%SPEECH_ON%I\'m %recruit%, and there's talk across the land of you runnin\' around looking to prove \'urself%SPEECH_OFF%Your hand steadily crawls towards your weapon but the stranger takes note of this.%SPEECH_ON%No — not like that. In fact, im interesting in joining. The arenas in the south only have so many things to kill and the north can be...somewhat empty at times.%SPEECH_OFF%}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
		...
		this.m.Screens.push({ //Aggressive archetype
			ID = "B",
			Text = "[img]gfx/ui/events/event_76.png[/img]{%recruit% picks up their crossbow and loads a bolt. You place 3 bottles in a line on a nearby stone wall. They take aim as soon as you are clear and shoot the bottom out of one of the bottles. As they reload, they don\'t dare take their eye of their second target - effectively reloading blind.\n\n The next shot is a snap shot that grazes the second bottles, which causes it to tumble and smash from the top of the wall. %recruit% curses under their breath and this time relloads their weapon while looking down, quickly placing a new bolt into the groove.\n The third shot perfectly crowns the bottle neck and leaves the belly standing on the wall like a crow perches on a railing. The fourth bolt smashes dircetly through the middle of what remains a second or two later.}",
			Image = "",
			List = [],
			Characters = [],
			Options = [
