this.legend_solo_necro_intro_event <- this.inherit("scripts/events/event", {
	...
	function create()
	{
		...
		this.m.Screens.push({ //—
			...
			{
				this.logInfo("What is the fine for necrophilia in this part of Tamriel?");
