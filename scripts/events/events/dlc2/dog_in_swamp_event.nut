	...
	function create()
	{
		...
		this.m.Screens.push({
			...
			Options = [
				...
				{
					Text = "Comrades, we\'ve got to help that dog!",
					function getResult( _event )
					{
