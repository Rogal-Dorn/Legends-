this.minstrel_and_troubador_event <- this.inherit("scripts/events/event", {
	...
	function onUpdateScore()
	{
		...
		this.m.Troubadour = candidates_troubador[this.Math.rand(0, candidates_other.len() - 1)];
