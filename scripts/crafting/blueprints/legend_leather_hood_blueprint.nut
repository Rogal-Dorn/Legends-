this.legend_leather_hood_blueprint <- this.inherit("scripts/crafting/blueprint", {
	...
	function create()
	{
		...
		this.m.PreviewCraftable = this.new("scripts/items/helmets/helmet/cultist_leather_hood");
		this.m.Cost = 50;
		local ingredients = [
			{
	...
	{
		local item = this.new("scripts/items/helmets/helmet/cultist_leather_hood");
