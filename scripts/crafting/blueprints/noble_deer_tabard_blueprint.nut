this.noble_deer_tabard_blueprint <- this.inherit("scripts/crafting/blueprint", {
	...
	function create()
	{
		...
		this.m.PreviewCraftable = this.new("scripts/items/legend_armor/tabard/legend_armor_deer_tabard");
		this.m.Cost = 2000;
		local ingredients = [
			{
	...
	{
		local item = this.new("scripts/items/legend_armor/tabard/legend_armor_deer_tabard");
