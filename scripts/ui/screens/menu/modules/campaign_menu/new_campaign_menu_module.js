...
NewCampaignMenuModule.prototype.createDIV = function (_parentDiv) {
	...
	contentContainer.append(this.mFirstPanel); {
        ...
        rightColumn.append(row);
        var listContainerLayout = $('<div class="l-description-container"/>');
        row.append(listContainerLayout);
        this.mScenariosDescListContainer = listContainerLayout.createList(10, 'text-font-medium font-color-description');
        this.mScenariosDesc = this.mScenariosDescListContainer.findListScrollContainer();
