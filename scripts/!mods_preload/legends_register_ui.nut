::Const.LegendMod.registerUI <- function()
{
	// formations
	...
	::mods_registerCSS("screens/world/modules/camp/camp_screen_trader_dialog_module.css");
	::mods_registerCSS("screens/world/modules/camp/camp_screen_recruit_dialog_module.css");
