this.furs_item <- this.inherit("scripts/items/trade/trading_good_item", {
	...
	function create()
	{
		...
		this.m.ID = "misc.furs";
		this.m.Name = "Furs";
		this.m.Description = "Warm furs from wild animals. Traders will pay good coin for this.";
	...
	function getBuyPrice()
	{
		...
		{
			local isBuildingPresent = this.World.State.getCurrentTown().hasAttachedLocation("attached_location.trapper");
