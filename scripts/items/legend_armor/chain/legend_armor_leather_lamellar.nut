this.legend_armor_leather_lamellar <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Icon = "legend_armor/chain/icon_legend_armor_leather_lamellar.png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/chain/icon_legend_armor_leather_lamellar.png";
		this.m.OverlayIconLarge = "legend_armor/chain/inventory_legend_armor_leather_lamellar.png";
		this.m.SpriteFront = null;
		this.m.SpriteBack = "legend_armor_leather_lamellar";
		this.m.SpriteDamagedFront = null;
		this.m.SpriteDamagedBack = "legend_armor_leather_lamellar_damaged";
		this.m.SpriteCorpseFront = null;
		this.m.SpriteCorpseBack = "legend_armor_leather_lamellar_dead";
		this.m.Value = 300;
		this.m.Condition = 95;
