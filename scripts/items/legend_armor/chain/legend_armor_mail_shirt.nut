this.legend_armor_mail_shirt <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Icon = "legend_armor/chain/icon_legend_armor_mail_shirt.png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/chain/icon_legend_armor_mail_shirt.png";
		this.m.OverlayIconLarge = "legend_armor/chain/inventory_legend_armor_mail_shirt.png";
		this.m.SpriteFront = null;
		this.m.SpriteBack = "legend_armor_mail_shirt";
		this.m.SpriteDamagedFront = null;
		this.m.SpriteDamagedBack = "legend_armor_mail_shirt_damaged";
		this.m.SpriteCorpseFront = null;
		this.m.SpriteCorpseBack = "legend_armor_mail_shirt_dead";
		this.m.Value = 650;
	...
	function getTooltip()
	{
		...
		result.push({
			...
			text = "[color=" + this.Const.UI.Color.PositiveValue + "]+130[/color] Durability"
		});
		result.push({
			id = 14,
			type = "text",
