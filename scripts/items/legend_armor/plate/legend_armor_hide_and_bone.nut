this.legend_armor_hide_and_bone <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function create()
	{
		...
		this.m.Icon = "legend_armor/plate/icon_legend_armor_hide_and_bone.png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/plate/icon_legend_armor_hide_and_bone.png";
		this.m.OverlayIconLarge = "legend_armor/plate/inventory_legend_armor_hide_and_bone.png";
