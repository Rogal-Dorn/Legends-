this.legend_gambeson <- this.inherit("scripts/items/legend_armor/legend_armor", {
	...
	function create()
	{
		...
		this.m.Variant = this.Math.rand(1, 67);
		this.updateVariant();
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "legend_armor/inventory_legend_gambeson_" + variant + ".png";
		this.m.Icon = "legend_armor/icon_legend_gambeson_" + variant + ".png";
	}
