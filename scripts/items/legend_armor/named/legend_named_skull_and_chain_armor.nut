this.legend_named_skull_and_chain_armor <- this.inherit("scripts/items/legend_armor/named/legend_named_armor", {
	m = {},
	function create()
	{
		this.legend_named_armor.create();
		this.m.ID = "legend_armor.body.named_skull_and_chain_armor";
