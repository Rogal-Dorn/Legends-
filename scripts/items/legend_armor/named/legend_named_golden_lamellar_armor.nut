this.legend_named_golden_lamellar_armor <- this.inherit("scripts/items/legend_armor/named/legend_named_armor", {
	m = {},
	function create()
	{
		this.legend_named_armor.create();
		this.m.ID = "legend_armor.body.named_golden_lamellar_armor";
