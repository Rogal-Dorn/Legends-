this.vazl_runed_pitchfork <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_pitchfork";
		...
		this.m.IconLarge = "weapons/melee/runed_pitchfork_01.png";
		this.m.Icon = "weapons/melee/runed_pitchfork_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_pitchfork_01";
		this.m.Value = 150;
