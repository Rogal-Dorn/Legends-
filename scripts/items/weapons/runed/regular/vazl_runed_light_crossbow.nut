this.vazl_runed_light_crossbow <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {
		IsLoaded = true
	},
	function isLoaded()
	...
	function create()
	{
		...
		this.m.ID = "weapon.vazl_runed_light_crossbow";
		...
		this.m.IconLarge = "weapons/ranged/runed_crossbow_02.png";
		this.m.Icon = "weapons/ranged/runed_crossbow_02_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_crossbow_02";
		this.m.Value = 300;
		this.m.RangeMin = 1;
		this.m.RangeMax = 6;
		this.m.RangeIdeal = 6;
