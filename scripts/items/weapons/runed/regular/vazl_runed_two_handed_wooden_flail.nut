this.vazl_runed_two_handed_wooden_flail <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_two_handed_wooden_flail";
		...
		this.m.IconLarge = "weapons/melee/runed_flail_two_handed_01.png";
		this.m.Icon = "weapons/melee/runed_flail_two_handed_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_flail_two_handed_01";
		this.m.Value = 500;
