this.vazl_runed_two_handed_flanged_mace <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_two_handed_flanged_mace";
		...
		this.m.IconLarge = "weapons/melee/runed_mace_two_handed_02.png";
		this.m.Icon = "weapons/melee/runed_mace_two_handed_02_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_mace_two_handed_02";
		this.m.Value = 1600;
