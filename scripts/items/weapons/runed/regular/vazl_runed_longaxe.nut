this.vazl_runed_longaxe <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_longaxe";
		this.m.Name = "Longaxe";
		...
		this.m.IconLarge = "weapons/melee/runed_longaxe_01.png";
		this.m.Icon = "weapons/melee/runed_longaxe_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_longaxe_01";
		this.m.Value = 1200;
