this.vazl_runed_pickaxe <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_pickaxe";
		this.m.Name = "Pickaxe";
		...
		this.m.IconLarge = "weapons/melee/runed_miners_pick_01.png";
		this.m.Icon = "weapons/melee/runed_miners_pick_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_pickaxe_01";
		this.m.Value = 120;
