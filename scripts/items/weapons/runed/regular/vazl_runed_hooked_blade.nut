this.vazl_runed_hooked_blade <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_hooked_blade";
		...
		this.m.IconLarge = "weapons/melee/runed_hooked_blade_01.png";
		this.m.Icon = "weapons/melee/runed_hooked_blade_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_bill_02";
		this.m.Value = 700;
