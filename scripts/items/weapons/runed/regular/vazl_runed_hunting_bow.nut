this.vazl_runed_hunting_bow <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_hunting_bow";
		...
		this.m.IconLarge = "weapons/ranged/runed_bow_01.png";
		this.m.Icon = "weapons/ranged/runed_bow_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_hunting_bow";
		this.m.Value = 600;
		this.m.RangeMin = 2;
		this.m.RangeMax = 7;
		this.m.RangeIdeal = 7;
