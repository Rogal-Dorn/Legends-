this.vazl_runed_knife <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_knife";
		this.m.Name = "Knife";
		this.m.Description = "A short knife, not made for combat.";
		this.m.Categories = "Dagger, One-Handed";
		this.m.IconLarge = "weapons/melee/runed_knife_01.png";
		this.m.Icon = "weapons/melee/runed_knife_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_knife_01";
		this.m.Value = 30;
