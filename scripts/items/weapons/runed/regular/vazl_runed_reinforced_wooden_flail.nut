this.vazl_runed_reinforced_wooden_flail <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_reinforced_wooden_flail";
		...
		this.m.IconLarge = "weapons/melee/runed_flail_03.png";
		this.m.Icon = "weapons/melee/runed_flail_03_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_flail_03";
		this.m.Value = 300;
