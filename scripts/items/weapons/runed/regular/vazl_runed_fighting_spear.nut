this.vazl_runed_fighting_spear <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_fighting_spear";
		this.m.Name = "Fighting Spear";
		this.m.Description = "A long and sturdy spear built for battle.";
		this.m.Categories = "Spear, One-Handed";
		this.m.IconLarge = "weapons/melee/runed_spear_03.png";
		this.m.Icon = "weapons/melee/runed_spear_03_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_spear_03";
		this.m.Value = 2500;
