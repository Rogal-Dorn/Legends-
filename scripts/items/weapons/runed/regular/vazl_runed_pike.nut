this.vazl_runed_pike <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_pike";
		this.m.Name = "Pike";
		this.m.Description = "A long pike used for thrusting over some distance and keeping the enemy at bay.";
		this.m.Categories = "Polearm, Two-Handed";
		this.m.IconLarge = "weapons/melee/runed_pike_01.png";
		this.m.Icon = "weapons/melee/runed_pike_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_pike_01";
		this.m.Value = 900;
