this.vazl_runed_two_handed_wooden_hammer <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_two_handed_wooden_hammer";
		...
		this.m.IconLarge = "weapons/melee/runed_hammer_two_handed_02.png";
		this.m.Icon = "weapons/melee/runed_hammer_two_handed_02_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_hammer_02";
		this.m.Value = 500;
