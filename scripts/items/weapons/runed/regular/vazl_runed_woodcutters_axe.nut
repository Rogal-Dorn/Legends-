this.vazl_runed_woodcutters_axe <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_woodcutters_axe";
		...
		this.m.IconLarge = "weapons/melee/runed_axe_two_handed_02.png";
		this.m.Icon = "weapons/melee/runed_axe_two_handed_02_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_axe_two_handed_02";
		this.m.Value = 400;
