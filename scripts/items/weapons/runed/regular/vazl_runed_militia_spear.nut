this.vazl_runed_militia_spear <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_militia_spear";
		this.m.Name = "Militia Spear";
		this.m.Description = "A simple wooden spear with a metal tip.";
		this.m.Categories = "Spear, One-Handed";
		this.m.IconLarge = "weapons/melee/runed_spear_02.png";
		this.m.Icon = "weapons/melee/runed_spear_02_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_spear_02";
		this.m.Value = 180;
