this.vazl_runed_warhammer <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/runed_warhammer_01.png";
		this.m.Icon = "weapons/melee/runed_warhammer_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_warhammer_01";
		this.m.Value = 2500;
