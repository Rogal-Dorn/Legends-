this.vazl_runed_goedendag <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_goedendag";
		...
		this.m.ArmamentIcon = "runed_icon_goedendag_01";
		this.m.Value = 600;
