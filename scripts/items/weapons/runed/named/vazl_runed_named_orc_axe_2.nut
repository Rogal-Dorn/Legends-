this.vazl_runed_named_orc_axe_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/orc_axe_named_02_140x70.png";
		this.m.Icon = "weapons/melee/orc_axe_named_02_70x70.png";
		this.m.ArmamentIcon = "icon_orc_weapon_02_named_02";
	}
