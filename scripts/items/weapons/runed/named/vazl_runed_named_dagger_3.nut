this.vazl_runed_named_dagger_3 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_named_dagger_3";
		...
		this.m.IconLarge = "weapons/melee/runed_dagger_named_03.png";
		this.m.Icon = "weapons/melee/runed_dagger_named_03_70x70.png";
		this.m.ArmamentIcon = "runed_icon_named_dagger_03";
	}
