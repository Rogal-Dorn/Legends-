this.vazl_runed_named_throwing_axe_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	...
	function create()
	{
		...
		this.m.Ammo = 5;
		this.m.AmmoMax = 5;
		this.m.ID = "weapon.vazl_runed_named_throwing_axe_2";
		...
		this.m.IconLarge = "weapons/melee/runed_throwing_axes_01_named_02.png";
		this.m.Icon = "weapons/melee/runed_throwing_axes_01_named_02_70x70.png";
		this.m.ArmamentIcon = "runed_icon_named_throwing_axes_02";
	}
