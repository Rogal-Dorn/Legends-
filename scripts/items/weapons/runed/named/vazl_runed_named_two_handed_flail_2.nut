this.vazl_runed_named_two_handed_flail_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/flail_two_handed_02_named_02.png";
		this.m.Icon = "weapons/melee/flail_two_handed_02_named_02_70x70.png";
		this.m.ArmamentIcon = "icon_flail_two_handed_02_named_02";
	}
