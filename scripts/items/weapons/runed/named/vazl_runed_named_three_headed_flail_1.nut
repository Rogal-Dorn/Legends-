this.vazl_runed_named_three_headed_flail_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {
		LastSkillUse = 0
	},
	function create()
	{
		...
		this.m.ID = "weapon.vazl_runed_named_three_headed_flail_1";
