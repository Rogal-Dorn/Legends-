this.vazl_runed_named_mace_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {
		StunChance = 30
	},
	function create()
	{
		...
		this.m.ID = "weapon.vazl_runed_named_mace_2";
		...
		this.m.IconLarge = "weapons/melee/runed_mace_01_named_02.png";
		this.m.Icon = "weapons/melee/runed_mace_01_named_02_70x70.png";
		this.m.ArmamentIcon = "runed_icon_named_mace_02";
	}
