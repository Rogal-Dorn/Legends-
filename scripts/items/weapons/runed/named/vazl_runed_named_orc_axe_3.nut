this.vazl_runed_named_orc_axe_3 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/orc_axe_named_03_140x70.png";
		this.m.Icon = "weapons/melee/orc_axe_named_03_70x70.png";
		this.m.ArmamentIcon = "icon_orc_weapon_02_named_03";
	}
