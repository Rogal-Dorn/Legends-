this.vazl_runed_named_orc_axe_3 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_named_orc_axe_3";
		...
		this.m.IconLarge = "weapons/melee/runed_orc_axe_named_03_140x70.png";
		this.m.Icon = "weapons/melee/runed_orc_axe_named_03_70x70.png";
		this.m.ArmamentIcon = "runed_icon_orc_weapon_02_named_03";
	}
