this.vazl_runed_named_warbrand_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/military_scythe_named_01.png";
		this.m.Icon = "weapons/melee/military_scythe_named_01_70x70.png";
		this.m.ArmamentIcon = "icon_named_warbrand_01";
	}
