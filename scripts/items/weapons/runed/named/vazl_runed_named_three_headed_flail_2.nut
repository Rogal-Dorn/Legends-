this.vazl_runed_named_three_headed_flail_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {
		LastSkillUse = 0
	},
	function create()
	{
		...
		this.m.ID = "weapon.vazl_runed_named_three_headed_flail_2";
		...
		this.m.IconLarge = "weapons/melee/runed_flail_three_headed_01_named_02.png";
		this.m.Icon = "weapons/melee/runed_flail_three_headed_01_named_02_70x70.png";
		this.m.ArmamentIcon = "runed_icon_flail_three_headed_01_named_02";
	}
