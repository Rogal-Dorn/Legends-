this.vazl_runed_named_two_handed_mace_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/mace_two_handed_02_named_01.png";
		this.m.Icon = "weapons/melee/mace_two_handed_02_named_01_70x70.png";
		this.m.ArmamentIcon = "icon_mace_two_handed_02_named_01";
	}
