this.vazl_runed_named_orc_cleaver_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/runed_orc_cleaver_named_02_140x70.png";
		this.m.Icon = "weapons/melee/runed_orc_cleaver_named_02_70x70.png";
		this.m.ArmamentIcon = "runed_icon_orc_weapon_04_named_02";
	}
