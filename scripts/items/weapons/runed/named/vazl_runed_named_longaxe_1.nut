this.vazl_runed_named_longaxe_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_named_longaxe_1";
		...
		this.m.IconLarge = "weapons/melee/runed_longaxe_named_01.png";
		this.m.Icon = "weapons/melee/runed_longaxe_named_01_70x70.png";
		this.m.ArmamentIcon = "runed_icon_named_longaxe_01";
	}
