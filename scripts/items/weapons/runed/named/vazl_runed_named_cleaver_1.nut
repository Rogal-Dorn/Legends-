this.vazl_runed_named_cleaver_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/cleaver_01_named_01.png";
		this.m.Icon = "weapons/melee/cleaver_01_named_01_70x70.png";
		this.m.ArmamentIcon = "icon_named_cleaver_01";
	}
