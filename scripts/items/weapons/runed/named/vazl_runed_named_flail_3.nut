this.vazl_runed_named_flail_3 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_named_flail_3";
		...
		this.m.IconLarge = "weapons/melee/runed_flail_01_named_03.png";
		this.m.Icon = "weapons/melee/runed_flail_01_named_03_70x70.png";
		this.m.ArmamentIcon = "runed_icon_named_flail_03";
	}
