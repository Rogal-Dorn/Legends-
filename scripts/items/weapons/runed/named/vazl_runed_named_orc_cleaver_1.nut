this.vazl_runed_named_orc_cleaver_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/orc_cleaver_named_01_140x70.png";
		this.m.Icon = "weapons/melee/orc_cleaver_named_01_70x70.png";
		this.m.ArmamentIcon = "icon_orc_weapon_04_named_01";
	}
