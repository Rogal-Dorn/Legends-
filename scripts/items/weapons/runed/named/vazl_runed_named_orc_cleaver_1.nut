this.vazl_runed_named_orc_cleaver_1 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_named_orc_cleaver_1";
		...
		this.m.IconLarge = "weapons/melee/runed_orc_cleaver_named_01_140x70.png";
		this.m.Icon = "weapons/melee/runed_orc_cleaver_named_01_70x70.png";
		this.m.ArmamentIcon = "runed_icon_orc_weapon_04_named_01";
	}
