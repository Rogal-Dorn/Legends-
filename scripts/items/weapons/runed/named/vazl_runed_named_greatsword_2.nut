this.vazl_runed_named_greatsword_2 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/runed_sword_two_hand_01_named_02.png";
		this.m.Icon = "weapons/melee/runed_sword_two_hand_01_named_02_70x70.png";
		this.m.ArmamentIcon = "runed_icon_named_greatsword_02";
	}
