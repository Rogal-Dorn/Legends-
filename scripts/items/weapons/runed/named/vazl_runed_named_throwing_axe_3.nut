this.vazl_runed_named_throwing_axe_3 <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/throwing_axes_01_named_03.png";
		this.m.Icon = "weapons/melee/throwing_axes_01_named_03_70x70.png";
		this.m.ArmamentIcon = "icon_named_throwing_axes_03";
	}
