this.vazl_runed_orc_javelin <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.ArmamentIcon = "runed_icon_javelin_01";
		this.m.Value = 150;
		this.m.Ammo = 5;
		this.m.AmmoMax = 5;
		this.m.RangeMin = 1;
	...
	function setAmmo( _a )
	{
		...
		else
		{
			...
			this.m.IconLarge = "weapons/ranged/runed_orc_javelins_bag_140x70.png";
			this.m.Icon = "weapons/ranged/runed_orc_javelins_bag_70x70.png";
