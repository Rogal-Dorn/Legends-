this.vazl_runed_orc_cleaver <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_orc_cleaver";
		...
		this.m.ArmamentIcon = "runed_icon_orc_weapon_04";
		this.m.Value = 1100;
