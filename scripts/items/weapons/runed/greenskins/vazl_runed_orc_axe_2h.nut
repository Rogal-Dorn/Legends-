this.vazl_runed_orc_axe_2h <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/runed_orc_axe_two_handed.png";
		this.m.Icon = "weapons/melee/runed_orc_axe_two_handed_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_orc_weapon_01";
		this.m.Value = 1500;
