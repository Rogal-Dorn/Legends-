this.vazl_runed_goblin_notched_blade <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_goblin_notched_blade";
		...
		this.m.ArmamentIcon = "runed_icon_goblin_weapon_01";
		this.m.Value = 350;
