this.vazl_runed_goblin_pike <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_goblin_pike";
		...
		this.m.ArmamentIcon = "runed_icon_goblin_weapon_04";
		this.m.Value = 800;
