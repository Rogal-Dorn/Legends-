this.vazl_runed_goblin_crossbow <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {
		IsLoaded = true
	},
	function isLoaded()
	...
	function create()
	{
		...
		this.m.ID = "weapon.vazl_runed_goblin_crossbow";
	...
	function getTooltip()
	{
		local result = this.vazl_runed_weapon.getTooltip();
	...
	function onCombatFinished()
	{
		this.vazl_runed_weapon.onCombatFinished();
