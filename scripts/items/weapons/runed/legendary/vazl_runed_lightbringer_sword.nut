this.vazl_runed_lightbringer_sword <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_lightbringer_sword";
		...
		this.m.IconLarge = "weapons/melee/runed_sword_legendary_01.png";
		this.m.Icon = "weapons/melee/runed_sword_legendary_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_sword_legendary_01";
