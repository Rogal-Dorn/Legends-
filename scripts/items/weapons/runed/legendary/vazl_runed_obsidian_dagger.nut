this.vazl_runed_obsidian_dagger <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_obsidian_dagger";
		...
		this.m.IconLarge = "weapons/melee/runed_obsidian_dagger_01.png";
		this.m.Icon = "weapons/melee/runed_obsidian_dagger_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_obsidian_dagger";
