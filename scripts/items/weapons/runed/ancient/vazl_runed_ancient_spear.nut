this.vazl_runed_ancient_spear <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	m = {},
	function create()
	{
		this.vazl_runed_weapon.create();
		this.m.ID = "weapon.vazl_runed_ancient_spear";
		...
		this.m.IconLarge = "weapons/melee/runed_ancient_spear_01.png";
		this.m.Icon = "weapons/melee/runed_ancient_spear_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_ancient_spear_01";
		this.m.Value = 150;
