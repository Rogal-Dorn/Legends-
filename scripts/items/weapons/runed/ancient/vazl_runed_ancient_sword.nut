this.vazl_runed_ancient_sword <- this.inherit("scripts/items/weapons/runed/vazl_runed_weapon", {
	...
	function create()
	{
		...
		this.m.IconLarge = "weapons/melee/runed_ancient_sword_01.png";
		this.m.Icon = "weapons/melee/runed_ancient_sword_01_70x70.png";
		...
		this.m.ArmamentIcon = "runed_icon_ancient_sword_01";
		this.m.Value = 850;
