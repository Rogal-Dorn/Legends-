this.legend_shovel <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.ItemType = this.Const.Items.ItemType.Weapon | this.Const.Items.ItemType.MeleeWeapon | this.Const.Items.ItemType.TwoHanded | this.Const.Items.ItemType.Shovel;
