this.legend_cat_o_nine_tails <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.ItemType = this.Const.Items.ItemType.Weapon | this.Const.Items.ItemType.MeleeWeapon | this.Const.Items.ItemType.OneHanded | this.Const.Items.ItemType.Cultist | this.Const.Items.ItemType.Ninetails;
