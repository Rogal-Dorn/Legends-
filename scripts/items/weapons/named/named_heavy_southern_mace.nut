this.named_heavy_southern_mace <- this.inherit("scripts/items/weapons/named/named_weapon", {
	m = {
		StunChance = 30
	},
	function create()
	{
		...
		this.m.Description = "A heavy winged mace. The smith who forged this weapon certainly knew what he was doing.";
