this.legend_parrying_dagger <- this.inherit("scripts/items/weapons/weapon", {
	m = {
		Variants = []
	},
	function create()
	{
		this.weapon.create();
		this.m.ID = "weapon.legend_parrying_dagger";
		...
		this.m.ItemType = this.Const.Items.ItemType.Weapon | this.Const.Items.ItemType.Defensive;
		this.m.Variants = [1]
