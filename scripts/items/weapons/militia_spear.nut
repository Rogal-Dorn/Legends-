this.militia_spear <- this.inherit("scripts/items/weapons/weapon", {
	...
	function create()
	{
		...
		this.m.ItemType = this.Const.Items.ItemType.Weapon | this.Const.Items.ItemType.MeleeWeapon | this.Const.Items.ItemType.OneHanded | this.Const.Items.ItemType.Defensive | this.Const.Items.ItemType.Militia;
