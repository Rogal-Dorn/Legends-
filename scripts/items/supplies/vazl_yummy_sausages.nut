this.vazl_yummy_sausages <- this.inherit("scripts/items/supplies/food_item", {
	m = {},
	function create()
	{
		this.food_item.create();
		this.m.ID = "supplies.vazl_yummy_sausages";
		this.m.Name = "Yummy Sausages";
		this.m.Description = "Provisions. These sausages sure look yummy!";
		this.m.Icon = "supplies/vazl_yummy_sausages.png";
		this.m.Value = 5;
