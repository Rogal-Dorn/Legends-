this.legend_liquor_item <- this.inherit("scripts/items/supplies/legend_usable_food", {
	...
	function create()
	{
		...
		this.m.Name = "Liquor";
		this.m.Description = "Provisions. Can be drunk in battle to grant +12 resolve, melee and ranged skill. At the expense of -24 initiative and -12% melee defense and ranged defense, the effect lasts for two turns. Will be used as provisions while travelling if left in the company inventory.";
