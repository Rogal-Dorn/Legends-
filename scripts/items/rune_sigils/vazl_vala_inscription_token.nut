this.vazl_vala_inscription_token <- this.inherit("scripts/items/item", {
	m = {},
	function create()
	{
		this.m.ID = "token.vazl_vala_inscription";
		this.m.Name = "";
		this.m.Description = "";
		this.m.Icon = "";
		this.m.IconLarge = "";
	...
	function getTooltip()
	{
		...
		result.push({
			id = 65,
			type = "text",
			text = "Right-click to permanently attach this inscribed rock to the selected character\'s equipment. This rock will be consumed in the process to give the following effect(s):"
		});
		result.push({
			id = 66,
			type = "text",
