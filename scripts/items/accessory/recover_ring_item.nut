this.recover_ring_item <- this.inherit("scripts/items/accessory/accessory", {
	m = {},
	function create()
	{
		this.accessory.create();
		this.m.ID = "accessory.recover_ring";
		this.m.Name = "Recover Ring";
		this.m.Description = "This ancient heirloom from the twisted house of Sylvania makes the vampire carrying it almost invincible.";
	...
	function onEquip()
	{
		...
		local misarme = this.new("scripts/skills/actives/Misarme_skill");
		misarme.setCooldown(Max);
		this.addSkill(misarme);
	}
