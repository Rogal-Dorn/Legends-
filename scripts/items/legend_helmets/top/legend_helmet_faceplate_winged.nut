...
this.legend_helmet_faceplate_winged <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_faceplate_winged";
		this.m.Description = "TODO legend_helmet_faceplate_winged";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/top/inventory_faceplate_winged" + "_" + variant + ".png";
