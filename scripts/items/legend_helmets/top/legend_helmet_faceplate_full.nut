...
this.legend_helmet_faceplate_full <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_faceplate_full";
		this.m.Description = "TODO legend_helmet_faceplate_full";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/top/inventory_faceplate_full" + "_" + variant + ".png";
