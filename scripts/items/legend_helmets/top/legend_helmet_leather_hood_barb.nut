...
this.legend_helmet_leather_hood_barb <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_leather_hood_barb";
		this.m.Description = "TODO legend_helmet_leather_hood_barb";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/top/inventory_leather_hood_barb" + "_" + variant + ".png";
