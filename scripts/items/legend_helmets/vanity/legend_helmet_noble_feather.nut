...
this.legend_helmet_noble_feather <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_noble_feather";
		this.m.Description = "TODO legend_helmet_noble_feather";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/vanity/inventory_noble_feather" + "_" + variant + ".png";
