...
this.legend_helmet_witchhunter_helm <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_witchhunter_helm";
		this.m.Description = "TODO legend_helmet_witchhunter_helm";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/vanity/inventory_witchhunter_helm" + "_" + variant + ".png";
