...
this.legend_helmet_noble_hood <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_noble_hood";
		this.m.Description = "TODO legend_helmet_noble_hood";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/vanity/inventory_noble_hood" + "_" + variant + ".png";
