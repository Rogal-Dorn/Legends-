...
this.legend_helmet_rotten_chain_scarf <- this.inherit("scripts/items/legend_helmets/legend_helmet", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_rotten_chain_scarf";
		this.m.Description = "TODO legend_helmet_rotten_chain_scarf";
        this.m.Variant = 1;
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/hood/inventory_rotten_chain_scarf" + "_" + variant + ".png"
	}
});
