...
this.legend_helmet_hood_cloth_wide <- this.inherit("scripts/items/legend_helmets/legend_helmet", {
	m = {},
	function create()
	{
		this.legend_helmet.create();
		this.m.ID = "armor.head.legend_helmet_hood_cloth_wide";
		this.m.Name = "TODO legend_helmet_hood_cloth_wide";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/hood/inventory_hood_cloth_wide" + "_" + variant + ".png"
	}
});
