...
this.legend_helmet_hood_cloth_round <- this.inherit("scripts/items/legend_helmets/legend_helmet", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_hood_cloth_round";
		this.m.Description = "TODO legend_helmet_hood_cloth_round";
        this.m.Variant = 1;
		this.m.Variants = [1];
		this.updateVariant();
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/hood/inventory_hood_cloth_round" + "_" + variant + ".png"
	}
});
