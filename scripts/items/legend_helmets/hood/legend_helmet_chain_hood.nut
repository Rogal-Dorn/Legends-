...
this.legend_helmet_chain_hood <- this.inherit("scripts/items/legend_helmets/legend_helmet", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_chain_hood";
		this.m.Description = "TODO legend_helmet_chain_hood";
        this.m.Variant = 1;
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/hood/inventory_chain_hood" + "_" + variant + ".png"
	}
});
