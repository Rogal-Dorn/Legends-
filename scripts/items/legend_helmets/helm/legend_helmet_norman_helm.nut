...
this.legend_helmet_norman_helm <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_norman_helm";
		this.m.Description = "TODO legend_helmet_norman_helm";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_norman_helm" + "_" + variant + ".png";
