...
this.legend_helmet_legend_frogmouth <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_legend_frogmouth";
		this.m.Description = "TODO legend_helmet_legend_frogmouth";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_legend_frogmouth" + "_" + variant + ".png";
