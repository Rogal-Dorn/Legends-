...
this.legend_helmet_padded_cap <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	m = {},
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_padded_cap";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_padded_cap" + "_" + variant + ".png";
