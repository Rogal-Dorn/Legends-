...
this.legend_helmet_orc_metal_mask <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_orc_metal_mask";
		this.m.Description = "TODO legend_helmet_orc_metal_mask";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_orc_metal_mask" + "_" + variant + ".png";
