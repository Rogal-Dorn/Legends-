...
this.legend_helmet_horsetail <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_horsetail";
		this.m.Description = "TODO legend_helmet_horsetail";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_horsetail" + "_" + variant + ".png";
