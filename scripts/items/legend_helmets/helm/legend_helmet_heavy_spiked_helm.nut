...
this.legend_helmet_heavy_spiked_helm <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_heavy_spiked_helm";
		this.m.Description = "TODO legend_helmet_heavy_spiked_helm";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_heavy_spiked_helm" + "_" + variant + ".png";
