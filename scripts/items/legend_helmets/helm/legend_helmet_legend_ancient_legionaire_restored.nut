...
this.legend_helmet_legend_ancient_legionaire_restored <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_legend_ancient_legionaire_restored";
		this.m.Description = "TODO legend_helmet_legend_ancient_legionaire_restored";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_legend_ancient_legionaire_restored" + "_" + variant + ".png";
