...
this.legend_helmet_flat_top_face_plate <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_flat_top_face_plate";
		this.m.Description = "TODO legend_helmet_flat_top_face_plate";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_flat_top_face_plate" + "_" + variant + ".png";
