...
this.legend_helmet_ancient_legionaire <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_ancient_legionaire";
		this.m.Description = "TODO legend_helmet_ancient_legionaire";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/helm/inventory_ancient_legionaire" + "_" + variant + ".png";
