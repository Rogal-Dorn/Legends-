...
this.legend_helmet_back_crest <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "TODO legend_helmet_back_crest";
		this.m.Description = "TODO legend_helmet_back_crest";
	...
	function updateVariant()
	{
		...
		this.m.IconLarge = "";
		this.m.Icon = "legend_helmets/vanity_lower/inventory_back_crest" + "_" + variant + ".png";
