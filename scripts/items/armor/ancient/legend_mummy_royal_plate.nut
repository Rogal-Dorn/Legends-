this.legend_mummy_royal_plate <- this.inherit("scripts/items/armor/armor", {
	...
	function updateVariant()
	{
		...
		this.m.Sprite = "mummy_royal_plate_0" + variant;
		this.m.SpriteDamaged = "mummy_royal_plate_0" + variant + "_damaged";
		this.m.SpriteCorpse = "mummy_royal_plate_0" + variant + "_dead";
