this.legend_demon_hound_bones_item <- this.inherit("scripts/items/item", {
	...
	function create()
	{
		...
		this.m.Description = "A few bones from a Höllenhund; they still have a faint, eerie glow about them. Might fetch some coin from alchemists on the market place.";
