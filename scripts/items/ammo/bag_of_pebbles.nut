this.bag_of_pebbles <- this.inherit("scripts/items/ammo/ammo", {
	m = {},
	function create()
	{
		this.m.ID = "ammo.pebbles";
		this.m.Name = "Bag of pebbles";
		this.m.Description = "A bag of pebbles, required to use a sling. Is automatically refilled after each battle if you have enough ammunition.";
