this.tent_enchant <- this.inherit("scripts/items/trade/trading_good_item", {
	m = {},
	function create()
	{
		...
		this.m.Description = "A tent for storing and processing rune stones, upgrades your camp. Comes with the stones, chisels and songbooks used for enchanting.";
