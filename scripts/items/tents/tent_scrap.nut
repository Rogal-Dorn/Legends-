this.tent_scrap <- this.inherit("scripts/items/trade/trading_good_item", {
	...
	function create()
	{
		...
		this.m.Description = "One merc\'s trash is another treasure. This collection of spare parts will help you turn broken armor and weapons into usable armor scraps and tools. Upgrades your camp.";
