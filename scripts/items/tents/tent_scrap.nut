this.tent_scrap <- this.inherit("scripts/items/trade/trading_good_item", {
	...
	function create()
	{
		...
		this.m.Description = "One mercenary\'s trash is anothers' treasure. This collection of spare parts will help you turn broken armor and weapons into usable armor scraps and tools. Having this in your stash upgrades your camp.";
