this.dismount_horse <- this.inherit("scripts/skills/skill", {
	m = {
		Item = null,
		Sounds0 = [
	...
	function create()
	{
		this.m.ID = "actives.dismount_horse";
		this.m.Name = "Dismount horse";
		this.m.Description = "Dismount your horse and proceed on foot";
