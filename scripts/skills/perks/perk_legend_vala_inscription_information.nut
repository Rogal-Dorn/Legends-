...
// 		if (runeS != null && runeS.getCountdownTime() > 0)  // SHIELDS
// 		{
// 			tooltip.push({
// 				id = 10,
// 				type = "text",
...
// 		if (runeH != null && runeH.getCountdownTime() > 0)  // HELMETS
// 		{
// 			tooltip.push({
// 				id = 11,
// 				type = "text",
...
// 		if (runeA != null && runeA.getCountdownTime() > 0)  // ARMORS
// 		{
// 			tooltip.push({
// 				id = 12,
// 				type = "text",
...
// 		if (runeW != null && runeW.getCountdownTime() > 0)  // WEAPONS
// 		{
// 			tooltip.push({
// 				id = 13,
// 				type = "text",
