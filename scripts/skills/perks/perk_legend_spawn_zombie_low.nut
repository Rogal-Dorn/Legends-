this.perk_legend_spawn_zombie_low <- this.inherit("scripts/skills/skill", {
	...
	function onAdded()
	{
		if (!this.m.Container.hasSkill("actives.legends_spawn_zombie_low_skill"))
		{
			this.m.Container.add(this.new("scripts/skills/actives/legends_spawn_zombie_low_skill"));
		}
	}
	
	function onRemoved()
	{
		this.m.Container.removeByID("actives.legends_spawn_zombie_low_skill");
	}
