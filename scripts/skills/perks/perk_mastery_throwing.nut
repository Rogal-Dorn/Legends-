this.perk_mastery_throwing <- this.inherit("scripts/skills/skill", {
	...
	function onAnySkillUsed( _skill, _targetEntity, _properties )
	{
		...
		if (_skill.isRanged() && (_skill.getID() == "actives.throw_axe" || _skill.getID() == "actives.throw_balls" || _skill.getID() == "actives.throw_javelin" || _skill.getID() == "actives.throw_spear" || _skill.getID() == "actives.sling_stone" || _skill.getID() == "actives.legend_throw_knife"))
		{
