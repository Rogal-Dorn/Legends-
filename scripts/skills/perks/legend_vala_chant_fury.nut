	...
	function getTooltip()
	{
		...
		local ret = [
			...
			},
			{
				...
				text = "Until the start of her next turn the Vala, and any allies within 3 tiles of her, receives a bonus to their damage output and a chance to retaliate against attackers that hit them in melee range. Being closer to the Vala increases bonus amount and retaliation chance."
			},
		];
