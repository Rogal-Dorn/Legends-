...
this.perk_legend_magic_burning_hands <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		this.m.ID = "perk.legend_magic_burning_hands";
		this.m.Name = this.Const.Strings.PerkName.LegendMagicBurningHands;
		this.m.Description = this.Const.Strings.PerkDescription.LegendMagicBurningHands;
