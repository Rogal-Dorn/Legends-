this.perk_legend_ironside <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		this.m.ID = "perk.legend_ironside";
		this.m.Name = this.Const.Strings.PerkName.LegendIronside;
		this.m.Description = this.Const.Strings.PerkDescription.LegendIronside;
