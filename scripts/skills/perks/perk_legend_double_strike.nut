this.perk_legend_double_strike <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		this.m.ID = "perk.legend_double_strike";
		this.m.Name = this.Const.Strings.PerkName.LegendDoubleStrike;
		this.m.Description = this.Const.Strings.PerkDescription.LegendDoubleStrike;
