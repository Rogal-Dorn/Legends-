this.legend_specialist_shovel_damage <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
	...
	{
		if (this.m.Items.getItemAtSlot(this.Const.ItemSlot.Mainhand).getID() = "weapon.legend_shovel")
		{
