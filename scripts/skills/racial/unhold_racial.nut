this.unhold_racial <- this.inherit("scripts/skills/skill", {
	...
	function onTurnStart()
	{
		...
		if (!actor.getSkills().hasSkill("effects.spider_poison_effect") && !actor.getSkills().hasSkill("effects.legend_redback_spider_poison_effect") && !actor.getSkills().hasSkill("eeffects.legend_RSW_poison_effect")
		{
