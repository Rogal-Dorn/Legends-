// TODO images and sound, perks
this.mage_legend_magic_missile <- this.inherit("scripts/skills/actives/mage_legend_magic_attack", {
	m = {
		AdditionalAccuracy = 30,
		AdditionalHitChance = 0,
		BaseFatigueCost = 16,
		ReducedFatigueCost = 10
	},

	function create() {
		this.mage_legend_magic_attack.create();

		this.m.ID = "actives.mage_legend_magic_missile";
		this.m.Name = "Magic Missile";
