this.legend_pull <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "actives.legend_pull";
		this.m.Name = "Entice";
	...
	function getTooltip()
	{
		...
		ret.push({
			...
			text = "Has a range of [color=" + this.Const.UI.Color.PositiveValue + "]8[/color] tiles"
		});
		ret.push({
			id = 7,
			type = "text",
