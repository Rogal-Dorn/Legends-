this.legend_drums_of_war_skill <- this.inherit("scripts/skills/skill", {
	...
	function create()
	{
		...
		this.m.Description = "Push allies on with your music, lowering the fatigue of all allies within 3 tiles by 2 fatigue. Must be holding a musical instrument to use.";
