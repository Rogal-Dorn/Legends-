this.shadow_step <- this.inherit("scripts/skills/skill", {
	m = {
	...
	function create()
	{
		this.m.ID = "actives.shadow_step";
		this.m.Name = "Shadow Step";
		this.m.Description = "A shadowy blur is all your opponent sees before you\'ve passed through them";
