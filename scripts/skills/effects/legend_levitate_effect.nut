// TODO replace LegendFlightMovementApCost and LegendFlightMovementFatigueCost
this.legend_levitate_effect <- this.inherit("scripts/skills/skill", {
	m = {},
	function create()
	{
		this.m.ID = "effects.legend_levitate_effect";
