this.overwhelmed_effect <- this.inherit("scripts/skills/skill", {
	...
	{
		_properties.MeleeSkillMult = this.Math.maxf(0.0, _properties.MeleeSkillMult - 0.100000001 * this.m.Count);
		_properties.RangedSkillMult = this.Math.maxf(0.0, _properties.RangedSkillMult - 0.100000001 * this.m.Count);
	}
