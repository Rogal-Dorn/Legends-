this.legend_female_beggar_commander_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.ID = "background.legend_female_commander_beggar";
		...
		this.m.GoodEnding = "Having enough of all the fighting, %name% the once-beggar retired from the %companyname%. You know the woman made a pretty crown in her time with the mercenary company, yet the other day you saw her out begging again. You asked if she\'d wasted all his money and she laughed. She said she\'d purchased land and was doing just fine. Then she held out her little tin and asked for a crown. You gave her two.";
