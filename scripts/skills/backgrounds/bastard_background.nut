	...
	function onAddLegendEquipment()
	{
		...
		if (armor != null)
		{
			local chains = [
				...
				["chain/legend_armor_basic_mail", 0],
				["chain/legend_armor_hauberk", 0],
				["chain/legend_armor_hauberk_full", 0],
				["chain/legend_armor_hauberk_sleevless", 0],
				["chain/legend_armor_mail_shirt", 1],
				["chain/legend_armor_mail_shirt_simple", 1],
				["chain/legend_armor_reinforced_mail", 0],
				["chain/legend_armor_reinforced_mail_shirt", 0],
				...
				["chain/legend_armor_rusty_mail_shirt", 1],
				["chain/legend_armor_short_mail", 0]
			]
			...
			local plates = [
				...
				["plate/legend_armor_leather_jacket", 1],
				["plate/legend_armor_leather_jacket_simple", 1],
				...
				["plate/legend_armor_leather_padded", 1],
