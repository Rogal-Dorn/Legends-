this.goblin_ambusher_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {},
	function create()
	{
		this.character_background.create();
		this.m.ID = "background.goblin_ambusher";
		this.m.Name = "Goblin Ambusher";
		this.m.Icon = "ui/backgrounds/background_goblin_ambusher.png";
		this.m.BackgroundDescription = "Ambushers tend to have some skill in using bow and arrow to hunt down rabbits and the like.";
		...
		this.m.BackgroundType = this.Const.BackgroundType.Greenskin | this.Const.BackgroundType.Lowborn | this.Const.BackgroundType.Outlaw | this.Const.BackgroundType.Ranger | this.Const.BackgroundType.ExpertHunter;
	...
	function onAddEquipment()
	{
		...
		{
			items.addToBag(this.new("scripts/items/weapons/greenskins/goblin_notched_blade"));
		}
