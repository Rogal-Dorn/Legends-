this.legend_female_berserker_commander_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	m = {
		Tattoo = 0
	},
	function create()
	{
		...
		this.m.ID = "background.legend_female_commander_berserker";
