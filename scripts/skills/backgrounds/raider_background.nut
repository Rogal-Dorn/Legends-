this.raider_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.GoodEnding = "A former raider, %name% fit in well with the %companyname% and proved himself an excellent fighter. Having saved a veritable mountain of crowns, %they% retired from the company and returned from whence %they% came. %they% was last seen sailing a riverboat toward a small village.";
		this.m.BadEnding = "As the %companyname% speedily declined, %name% the raider departed from the company and went on his own way again. %they% returned to raiding, taking his greedy violence along the shorelines of river villages. You\'re not sure if it\'s true, but word has it that %they% was impaled with a pitchfork by a stable boy. Word has it that the town hoisted his body parts along the outer walls as a warning to future would-be raiders.";
