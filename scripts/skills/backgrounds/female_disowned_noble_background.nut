this.female_disowned_noble_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.BackgroundDescription = "Disowned nobles often have profited from some training in ranged warfare at court.";
		...
		this.m.BackgroundType = this.Const.BackgroundType.Female | this.Const.BackgroundType.Combat | this.Const.BackgroundType.Noble | this.Const.BackgroundType.Ranger | this.Const.BackgroundType.Outlaw | this.Const.BackgroundType.Educated;
