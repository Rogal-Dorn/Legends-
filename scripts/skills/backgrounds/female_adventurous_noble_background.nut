this.female_adventurous_noble_background <- this.inherit("scripts/skills/backgrounds/character_background", {
	...
	function create()
	{
		...
		this.m.Name = "Adventurous Noblewoman";
