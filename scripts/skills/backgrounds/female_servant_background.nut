		...
		ret.push(
			{
				...
				text = "Housemaids provide [color=" + this.Const.UI.Color.PositiveValue + "]+5[/color] stash spaces, [color=" + this.Const.UI.Color.PositiveValue + "]-5%[/color] medicine consumption, [color=" + this.Const.UI.Color.PositiveValue + "]+13[/color] maximum medicine storage,  [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] healing while in healing tent, [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] injury healing while in healing tent, [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] repair while in the repair tent, [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] salvage while in the salvage tent, [color=" + this.Const.UI.Color.PositiveValue + "]+50%[/color] crafting while in the crafting tent, [color=" + this.Const.UI.Color.PositiveValue + "]+1%[/color] barter while trading and delivering, [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] fletching while in the fletching tent. [color=" + this.Const.UI.Color.PositiveValue + "]+30%[/color] medicine while in gathering in camp.). "
			}
		)
		return ret
	}
