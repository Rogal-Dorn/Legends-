...
gt.Const.LegendMod.Starts <- [
	...
	{
        name = "Noble",
        description = "Medium. Leadership, barter and support skills. 6 man start 27 max.",
    ...
    },
    {
        ...
        description = "Hard. Ranged damage skills. Grants followers Pathfinder. Solo start, 24 max recruits.",
    ...
    },    
    {
        ...
        description = "Hard.  Blood magic and necromancy. Solo start, 18 max recruits.",
