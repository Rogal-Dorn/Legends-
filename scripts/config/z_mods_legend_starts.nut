...
gt.Const.LegendMod.Starts <- [
    ...
    },
    {
        ...
        description = "Hard. Strong, righteous and deadly.Great melee stats and gear, tanking and damage perks. +10 max tools 20% repair rate increase -20% tool consumption ",
    ...
    },
    {
        ...
        description = "Harder. Great ranged stats, excelent damage perks. walks faster in forrests +30 max ammo",
    ...
    // },
    {
        ...
        description = "Harder. Focus on crowd control skills. +10 max meds +20% heal speed -50% med consumption.",
    ...
    },
    {
        ...
        description = "Harder. Focus on debuffs and the dark arts. +20% increased heal rate, -50% med use",
    ...
    // },
	{
       ...
       description = "Hard. A path of carnage and rage. AOE melee damage perks. moves faster in swamps, snow, mountains, hills and badlands",
       banner = gt.Const.LegendMod.StartTypes.Berserker
    },
	{
        name = "Noble",
        description = "Hard. Leadership and support skills. +15 stash, +10 max meds, +5 max tools, +15 max ammo, -10% tool use, +10/% heal speed, Marches faster on plains and farmland",
	...
	{
        name = "Party",
        description = "Easy. Weaker versions of Noble, Berserker, Warlock, Seer, Ranger and Crusader in one party. Very powerful skill combinations, but you can never hire anyone more",
