   ...
   // },
	{
       ...
       description = "Medium. Solo commander. AOE melee damage, moves fast in mountains and wildlands",
    ...
    },
    {
        ...
        description = "Medium. 2 roster slots, faith and melee perks. Great gear and repair rates",
        banner = gt.Const.LegendMod.StartTypes.Crusader
    },
	{
        name = "Noble",
        description = "Easy. 6 man start. Leadership and support skills. More supplies and slower supply usage, faster marching speed on flat land",
    ...
    },
    {
        ...
        description = "Medium. 3 roster slots, grants followers pathfinder. Great ranged damage. walks faster in forests",
    ...
    // },
    {
        ...
        description = "Harder. Solo avatar, crowd control skills. Heals your party faster",
        banner = gt.Const.LegendMod.StartTypes.Witch
    },
    {
        name = "Vala",
        intro = "[img]gfx/ui/events/event_24.png[/img]Vala",
    ...
    },    
    {
        ...
        description = "Harder. Solo avatar, Blood magic and undead allies.",
