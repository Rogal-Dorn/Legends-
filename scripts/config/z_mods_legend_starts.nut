...
gt.Const.LegendMod.Starts <- [
	...
	{
        name = "Noble",
        description = "Medium. Leadership, barter and support skills. 6 man start 27 max. Begins with good reputation.",
    ...
    },
    {
        ...
        description = "Hard. Starts at war with nobles, with only a single friendly settlement. Friendly with bandits.",
    ...
    },
    {
        ...
        description = "Hard. Ranged damage skills. Grants followers Pathfinder. Solo start, 24 max recruits. Friendly with beasts",
    ...
    },
    {
        ...
        description = "Easy. Melee defense skills, armor and faith. Solo start, 20 max recruits.  ",
    ...
    },
	{
       ...
       description = "Medium. Melee attack skills, berserk and great stats. Solo start, 16 max recruits.",
    ...
    },    
    {
        ...
        description = "Hard.  Blood magic and necromancy. Solo start, 18 max recruits. Friendly with zombies",
    ...
    },
    {
        ...
        description = "Harder. Crowd control and damage spells. Solo start, 22 max recruits.",
