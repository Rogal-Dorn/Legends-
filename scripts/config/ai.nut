...
gt.Const.AI <- {
	...
	AllottedTimePerEvaluationRun = 0.00499999989,
	HeatRange = 5,
	Agent = {
		ID = {
			Player = "agent.player",
	...
	Properties = {
		...
		TargetPriorityHitpointsMult = 0.300000012,
		TargetPriorityRandomMult = 0.0,
		TargetPriorityDamageMult = 0.200000003,
		TargetPriorityFleeingMult = 0.600000024,
		TargetPriorityHittingAlliesMult = 0.100000001,
		...
		OverallHideMult = 0.0,
		EngageWhenAlreadyEngagedMult = 0.200000003,
	...
	Behavior = {
		...
		AttackRangedScoreCutoff = 0.200000003,
		...
		MinDangerHitpointsPct = 0.200000003,
		...
		RetreatMinAllyRatio = 0.349999994,
		...
		EngageOnBadTerrainMult = 0.850000024,
		...
		EngageMovingTargetLongDistanceMult = 0.899999976,
		EngageLevelDisadvantagePenalty = 3,
		EngageLevelDisadvantageMult = 0.899999976,
		...
		EngageWhenAlreadyInRangeMult = 0.100000001,
		...
		EngageMeleeProtectPriorityTargetMult = 1.5,
		EngageWaitWithPolearmMult = 0.330000013,
		...
		RangedEngageTVTotalScoreMult = 0.150000006,
		...
		RangedEngageTargetInRangeMult = 0.800000012,
		...
		RangedEngageLessPerTileMult = 0.0500000007,
		EngageWithNoWeaponMult = 0.5,
		DefendInertiaMult = 1.10000002,
		DefendInertiaMaxMult = 1.5,
		DefendMaxEngagedAlliesRatio = 0.0500000007,
		...
		DefendOnBadTerrainMult = 0.800000012,
		...
		ShieldwallOpponentToAllyRatioMult = 0.330000013,
		...
		ShieldwallHeavilyWoundedMult = 0.330000013,
		ShieldwallLowPriorityMult = 0.5,
		ShieldwallInMeleeWithFlailMult = 0.899999976,
		...
		ShieldwallMinAllyOpponentRatio = 0.349999994,
		...
		SplitShieldAlternativeTargetValuePct = 0.899999976,
		SplitShieldAlternativeTargetMult = 0.100000001,
		...
		DarkflightMeleeHitpointsMult = 0.200000003,
		...
		DarkflightInertiaMult = 0.330000013,
		DarkflightMaxInertia = 2,
		DarkflightBadTerrainMult = 0.899999976,
		DarkflightDangerDestMult = 1.5,
		DarkflightDangerScoreMult = 0.5,
		DarkflightMultipleOpponentsMult = 0.899999976,
		DarkflightTileBlockedBonus = 0.5,
		DarkflightTacticalValueMult = 0.300000012,
		...
		DarkflightHatredForArmorMult = 0.100000001,
		DarkflightHatredForMeleeDefenseMult = 0.100000001,
		DarkflightQuickhandsMult = 0.899999976,
		DarkflightDangerMult = 3.0,
		MoveTailNearHeadMult = 100.0,
		MoveTailAlreadyEngagedMult = 0.5,
		MoveTailMaxDistanceToHead = 1,
		MoveTailCurrentTileBonus = 0.100000001,
		CommandUndeadRefreshMult = 0.330000013,
		CommandUndeadEngagedMult = 0.5,
		CommandUndeadTargetsInRangeMult = 1.0,
		CommandUndeadHitpointsMult = 1.0,
		CommandUndeadDangerMult = 0.330000013,
		CommandUndeadMinScoreMult = 0.200000003,
		...
		RaiseUndeadNoWeaponMult = 0.660000026,
		...
		PossessUndeadNoWeaponMult = 0.660000026,
		...
		GruesomeFeastDangerPenaltyMult = 0.100000001,
		GruesomeFeastLeaveZOC = -15.0,
		GruesomeFeastLeaveZOCMult = 0.0900000036,
		...
		LineBreakerBetterTargetThreshold = 0.0599999987,
		...
		ThrowNetTVMult = 0.330000013,
		ThrowNetMinAttaction = 0.699999988,
		...
		DisengageWithShieldMult = 0.899999976,
		...
		SleepTurnDoneMult = 0.100000001,
		SleepEvenMoreMult = 1.25,
		SleepEnoughMult = 0.75,
		SleepAlreadyAppliedMult = 0.100000001,
		SleepRedundantPOW = 0.800000012,
		...
		CorruptionRedundantPOW = 0.850000024,
		...
		CharmTargetUnarmedMult = 0.100000001,
		CharmTargetWoodenClubOnlyMult = 0.25,
		CharmTargetWoodenClubRightNowMult = 0.899999976,
		CharmLowerDurationMult = 0.75,
		CharmRangedWouldBeInZOCMult = 0.330000013,
		CharmWardogMult = 0.5,
		CharmRangedTargetMult = 1.5,
		CharmImmuneMult = 0.100000001,
		HexCharacterLevelMult = 0.200000003,
		HexNoAttacksMult = 0.5,
		HexZoneOfControlMult = 1.5,
		HexPreferPlayerMult = 4.0,
		HexDOTScoreMult = 1.25,
		HexDOTCanKillMult = 10.0,
		HexNotAGoodTargetMult = 0.100000001,
		HexAgainstIndomitable = 0.75,
		MoveTentacleZOCMult = 0.899999976,
