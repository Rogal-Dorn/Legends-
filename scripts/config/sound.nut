...
// Use MSU WeaponType to determine which sound to return
gt.Const.Sound.getParrySoundByWeaponType <- function (_skill)
{
	...
	else if (item.isWeaponType(this.Const.Items.WeaponType.Spear | this.Const.Items.WeaponType.Polearm))
	{
	...
	else if (item.isWeaponType(this.Const.Items.WeaponType.Flail | this.Const.Items.WeaponType.Staff))
	{
		return "sounds/combat/legend_parried_04.wav";
	}
	else if (item.isWeaponType(this.Const.Items.WeaponType.Mace | this.Const.Items.WeaponType.Axe))
	{
	...
	{
		return "sounds/combat/legend_parried_01";
	}
}
