...
gt.Const.Strings.PerkDescription <- {
	...
	LegendTrueBeliever = "Lesser men may cower and flee, but you are unassuageable in your commitment. Allies fleeing or dying no longer lowers this character\'s morale. This character gains 5% resolve for every fleeing character on the field, friend or foe.  Also removes the Superstitious trait. \n[color=#0b0084]From the Devious perk group[/color]",
	...
	LegendFavouredEnemySoutherner = "Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while southerners. Bonus increases the more southerners you kill. This includes Nomadic enemies, Desert Stalkers, Slaves, Conscripts, and more.  The bonus depends on how powerful the southerner is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.08%[/color] per Nomad Cutthroat, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.3%[/color] per Executioner you kill",
