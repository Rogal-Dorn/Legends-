...
gt.Const.Strings.PerkName <- {
	...
	LegendFullForce = "Unstoppable Force",
...
gt.Const.Strings.PerkDescription <- {
	...
	PerfectFocus = "Unlocks the \'Perfect Focus\' skill which allows the use of all other skills for one round at half the normal Action Point cost (rounded down), but +75% fatigue cost. \n[color=#0b0084]From the Calm perk group[/color]",
	...
	Debilitate = "Unlocks the \'Debilitate\' skill which can prime your next attack to cripple a target for three turns, reducing their ability to inflict damage by [color=" + this.Const.UI.Color.NegativeValue + "]-25%[/color]. \n[color=#0b0084]From the Vicious perk group[/color]",
	...
	Fearsome = "Make them scatter and flee! Any attack that inflicts at least 1 point of damage to hitpoints triggers a morale check for the opponent with a penalty equal to [color=" + this.Const.UI.Color.NegativeValue + "]20%[/color] of your Resolve, as opposed to with no penalty and only if at or above 15 points of damage.[color=#0b0084]From the Cleaver perk group[/color]",
	HeadHunter = "Go for the head! Hitting the head of a target will give you a guaranteed hit to the head also with your next attack. Connecting with your hit, or missing with your attack, will reset the effect. [color=#0b0084]From the Flail perk group[/color]",
	...
	BloodyHarvest = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] chance to hit for all Melee area of effect attacks. \n[color=#0b0084]From the Two Handed Sword perk group[/color]",
	...
	LegendFullForce = "Put your full weight into defending every blow and gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] of the combined fatigue modifier from body, head, main hand and off hand as Melee Defense. \n[color=#0b0084]From the Heavy Armor perk group[/color]",
	...
	BattleForged = "Specialize in heavy armor! Armor damage taken is reduced by a percentage equal to [color=" + this.Const.UI.Color.PositiveValue + "]3.5%[/color] of the current total armor value of both body and head armor. The heavier your armor and helmet, the more you benefit.\n\nDoes not affect damage from mental attacks or status effects, but can help to avoid receiving them. \n[color=#0b0084]From the Heavy Armor perk group[/color]",
	...
	Ballistics = "The range penalty to hitchance is reduced by [color=" + this.Const.UI.Color.NegativeValue + "]-2[/color] per tile. \n[color=#0b0084]From the Crossbow perk group[/color]",
	...
	LegendSpecialistPickaxeDamage = "Allows this character to mine for materials while assigned to gather in camp, and provides a small chance to harvest when smashing rocks in battle. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a pickaxe, or [color=" + this.Const.UI.Color.PositiveValue + "]+1-3[/color] damage when wielding 2 handed hammers. \n[color=#0b0084]From the Miner perk group[/color]",
	...
	LegendSpecialistShortbowDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a shortbow, wonky bow or boondock bow. Only 25% of this skill applies to other bows. \n[color=#0b0084]From the Shortbow perk group[/color]",
	LegendSpecialistShortbowSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] ranged skill and 25% armor penetration while using a shortbow, wonky bow or boondock bow. Only 25% of this applies to other bows.  \n[color=#0b0084]From the Shortbow perk group[/color] ",
	...
	LegendSpecialistWoodaxeDamage = "Allows this character to harvest wood while gathering in camp, also allows axes to harvest wood when breaking sticks during battle. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a Woodcutter\'s Axe or Saw, or [color=" + this.Const.UI.Color.PositiveValue + "]+1-3[/color] damage while using other axes. \n[color=#0b0084]From the Lumberjack perk group[/color]",
	...
	LegendFavouredEnemyLindwurm = "Understanding the morphology of these noxious serpents opens up weak spots in their scales. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting lindwurms or serpents. Bonus increases the more Lindwurm you kill at a rate of [color=" + this.Const.UI.Color.PositiveValue + "]+0.9%[/color] damage per Lindwurm killed. Taking this perk unlocks an extremely difficult legendary contract to hunt a burrowing Stollwurm",
	LegendFavouredEnemyDirewolf = "The vicious jaws of a direwolf can tear limbs asunder. In the heat of their blood soaked frenzy, they leave themselves open for counter attack. Understanding these weaknesses grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting direwolves or hyenas. Bonus increases the more wolves you kill at a rate of [color=" + this.Const.UI.Color.PositiveValue + "]+0.15%[/color] damage per direwolf. Taking this perk unlocks an extremely difficult legendary contract to hunt the great white wolf",
	...
	LegendFavouredEnemySchrat = "The strong branches of a living tree are deadly foes, but trees can be felled with the right knowledge. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting schrats or golems. Bonus increases at a rate of [color=" + this.Const.UI.Color.PositiveValue + "]+0.7%[/color] per schrat you kill. Taking this perk unlocks a legendary contract to hunt an endlessly multiplying Heartwood Schrat",
	...
	LegendFavouredEnemyZombie = "Shambling corpses come wave on wave, rising sleepless from their graves. They lose something crucial in death, and that can be exploited. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting wiedergangers. Also increases spawn rate of fallen heroes. Bonus increases the more Wiederganger you kill, the rate depends on how powerful the wiederganger is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.05%[/color] per weideganger, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.25%[/color] per Fallen Hero",
	...
	LegendFavouredEnemyArcher = "Some may claim to be the greatest shot in the land, but none have outshot you yet. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting archers. Bonus increases the more archers you kill. This includes Master Archers, Bandit Marksmen and poachers, Militia Archers, Arbalesters and Goblin Ambushers. The bonus depends on how powerful the archer is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.08%[/color] per Bandit Poacher, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Master Archer you kill. Also reduces the penalty for targets behind cover by 33%.",
	LegendFavouredEnemySwordmaster = "The path to martial prowess is beset by the fake and the weak. Only one can be the greatest swordsman. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting elite swordsmen. Bonus increases the more swordsmen you kill. This includes Hedgeknights, Knights, Zweihanders, Swordmasters, Bandit Leaders and Sergeants.  The bonus depends on how powerful the swordsman is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.3%[/color] per Bandit Leader, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Knight you kill",
	...
	LegendFavouredEnemySoutherner = "The southern city states are horrific, their slavery and conscription are afronts to human dignity. Their power must be overthrown. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while southerners. Bonus increases the more southerners you kill. This includes Gunners, Officers, Engineers, Assassins, Conscripts, and more.  The bonus depends on how powerful the southerner is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.08%[/color] per Conscript, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Veteran Manhunter you kill",
	LegendFavouredEnemyNomad = "The southern nomads are uncivilised heathens, without even towns to their name, they must be brought to heel. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting nomads. Bonus increases the more nomads you kill. This includes Nomadic outlaws, cutthroats, Desert Stalkers, Slaves, Executioners and more.  The bonus depends on how powerful the nomad is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.08%[/color] per Nomad Cutthroat, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Executioner you kill",
	...
	LegendClarity = "A well honed mind can perceive more in each instant, making time appear slower in key instants of need. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+1[/color] Action Point, but all fatigue costs are increased by [color=" + this.Const.UI.Color.NegativeValue + "]+20%[/color] . Does not work if you have Berserk or are dazed, drunk, hungover, taunted, staggered, horrified, concussed or fleeing. Gain an additional [color=" + this.Const.UI.Color.PositiveValue + "]+1[/color] Action Point and [color=" + this.Const.UI.Color.NegativeValue + "]+20%[/color] fatigue cost if under the effect of potions that improve cognition: Iron Will, Lionheart, Cat, Recovery or Hexen Ichor. \n[color=#0b0084]From the Calm perk group[/color]",
	...
	LegendBloodbath = "Take joy in the suffering of others, gain Fatigue and Resolve for each bleeding character on the field. The percentage gained is equal to the percentage of characters that are bleeding or have temporary injuries, including your own. [color=#0b0084]From the Cleaver perk group[/color]",
	...
	LegendGatherer = "Knowledge of the landscape and vegetation provides a wealth of opportunities when gathering in camp. Apothecaries usually gain their level as a percentage reduction in hours required to find special items. This skill doubles that bonus to twice their level. When the total bonus from all apothecaries is above 10%, they can also find mushrooms, poisons, antidotes and powders [color=#0b0084]From the Apothecary perk group[/color]",
	LegendPotionBrewer = "Expertise in potions and tinctures allows the creation of potions while gathering in camp. This skill unlocks the chance to create lionheart, ironwill, recovery and cat potions while gathering. An apothecary, druid or vala must gather the ingredients for the potion brewer. When the total level of all potion brewers gathering is above 20, they have a chance to create potions of knowledge and oblivion. Also unlocks alcohol crafting in the crafting tent. [color=#0b0084]From the Apothecary perk group[/color]",
	...
	LegendPacifist = "Fighting is a brutal thuggish pastime, most folk prefer a life without frequent bouts of extreme violence.  This character does not count towards your party strength when determining game difficulty. They will gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] resolve. They become content with being in reserve, and will grow unhappy if they are in more than half of the battles your company takes. [color=#0b0084]From the Organised perk group[/color]",
	...
	LegendPackleader = "Dogs can instinctively identify a pack leader, knowledge of their habits allows you to become the leader of their pack. Unlocks the ability to store additional dog items in your bags and use them in battle. [color=#0b0084]From the Dog Handling perk group[/color]",
	...
	LegendDogHandling = "You have mastered the art of training dogs. In the heat of battle your hounds will respond and react to your commands. Order them to attack or defend allies.[color=#0b0084]From the Dog Handling perk group[/color]",
	...
	LegendWindReader = "You have learned to read the wind, estimating the path of arrows in uncertain conditions. This is very helpful for dodging arrows, but can also be applied to shooting them as well.  Gain a third of your character\'s base Ranged Defence as Ranged Skill, with a minimum bonus of 3.  [color=#0b0084]From the Bow perk group[/color]",
	...
	LegendQuartermaster = "Meal planning and preparation is the key to avoiding wastage. By cooking bulk meals, using scraps and saving leftovers you can save food for the company. Reduces food consumption by 1 for every mercenary. This perk is only counted once per company. [color=#0b0084]From the Chef perk group[/color]",
