...
gt.Const.Strings.PerkDescription <- {
	...
	LegendFavouredEnemyNoble = "Soldiers in glittering armor and colourful pennants, their pride shall be their undoing. No gods, no masters. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] base bonus to melee skill, ranged skill and maximum damage against noble soldiers. Also increases spawn rate of noble champions. Additionally, this bonus increases the more noble soldiers you kill, the rate depends on how powerful the noble soldier is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.2%[/color] per footman, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Knight you kill.",
	...
	LegendFavouredEnemyArcher = "Some may claim to be the greatest shot in the land, but none have outshot you yet. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] base bonus to melee skill, ranged skill and maximum damage while fighting archers. Bonus increases the more archers you kill. This includes Master Archers, Bandit Marksmen and poachers, Militia Archers, Arbalesters and Goblin Ambushers. The bonus depends on how powerful the archer is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.08%[/color] per Bandit Poacher, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Master Archer you kill. Also reduces the penalty for targets behind cover by 33%.",
	...
	LegendFavouredEnemyMercenary = "Mercenaries are the worst, no cause, no principles, no honour. They seek only coin, so they shall find only death. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] base bonus to melee skill, ranged skill and maximum damage while fighting mercenaries. Bonus increases the more mercenaries, wardogs and bountyhunters you kill.  The bonus depends on how powerful the mercenary is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.09%[/color] per Wardog, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.3%[/color] per Mercenary you kill.",
