...
gt.Const.Strings.PerkDescription <- {
	...
	CoupDeGrace = "Inflict additional [color=" + this.Const.UI.Color.PositiveValue + "]20%[/color] damage against targets that have sustained any injury effects, like a broken arm. Also grants [color=" + this.Const.UI.Color.NegativeValue + "]+10%[/color] damage against targets who are stunned, netted or sleeping.\n[color=#0b0084]From the Polearm perk group[/color]",
