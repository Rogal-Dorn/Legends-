...
gt.Const.Strings.PerkDescription <- {
	...
	LegendRecuperation = "Heal more effectively over time.\n\n[color=#4f1800][u]Passive:[/u][/color]\n• Heal [color=" + this.Const.UI.Color.PositiveValue + "]+2[/color] Hitpoints at the end of every turn and recover [color=" + this.Const.UI.Color.PositiveValue + "]+2[/color] fatigue every turn.",
	...
	LegendUnburdened = "Unencumbered by armor, you are spry and fleet footed.\n\n[color=#4f1800][u]Passive:[/u][/color]\n• [color=#993b00]Blend in[/color] will now recover an evasion stack every 2 turns.\n\n• Increases Action Points by [color=" + this.Const.UI.Color.PositiveValue + "]1[/color] if this character has more than [color=" + this.Const.UI.Color.PositiveValue + "]50[/color]  bonus from [color=#993b00]Small Target[/color].\n\n[color=#4f1800][u]Active:[/u][/color]\n• Unlocks the [color=#400080]Unburdened Footwork[/color] skill, which allows you to leave a Zone of Control without triggering free attacks once per battle and at no cost to Action Points.",
