...
gt.Const.Strings.PerkDescription <- {
	...
	BattleFlow = "Once per turn, killing an opponent reduces current fatigue by [color=" + this.Const.UI.Color.NegativeValue + "]-25%[/color] of the base maximum fatigue (before penalties due to armor are applied). [color=#0b0084]From the Flail perk group[/color]",
