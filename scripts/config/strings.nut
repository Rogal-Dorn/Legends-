...
gt.Const.Strings.PerkDescription <- {
	...
	HoldOut = "Keep it together! Any negative status effect with a finite duration (e.g. Bleeding, Charmed) has its duration reduced by [color=" + this.Const.UI.Color.NegativeValue + "]-1[/color] turn, to a minimum of 1 turn. Also grants [color=" + this.Const.UI.Color.PositiveValue + "]+6[/color] hitpoints \n[color=#0b0084]From the Tenacious perk group[/color]",
	...
	LegendSmashingShields = "Some folks take joy in the simple pleasures of destroying shields. Grants an additional  [color=" + this.Const.UI.Color.PositiveValue + "]+100%[/color] shield damage on any successful hit. \n[color=#0b0084]From the Axe perk group[/color]",
	...
	LegendBloodbath = "Take joy in the suffering of others, gain Fatigue and Resolve for each bleeding character on the field. The percentage gained is equal to the percentage of characters that are bleeding, including your own. [color=#0b0084]From the Cleaver perk group[/color]",
	...
	LegendHerbcraft = "Knowledge of the properties of various roots and herbs lets you construct medicines from base ingredients. Allows the creation of medicine, antidotes and poisons in the crafting tent [color=#0b0084]From the Apocathery perk group[/color]",
