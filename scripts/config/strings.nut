...
gt.Const.Strings.PerkDescription <- {
	...
	LegendBigGameHunter = "The bigger they are...\n\nWhen fighting beasts, gain an additional modifier that deals bonus damage based on the target\'s missing health. When not fighting beasts, gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] ranged weapon damage but no additional modifier. Only works with ranged weapons.",
