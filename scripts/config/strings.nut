...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistNinetailsDamage = "Use your strength of will to turn the tips of the cattail to inflict horrible injuries. While wielding a cat of nine tails this skill increases damage by [color=" + this.Const.UI.Color.PositiveValue + "]+5-10%[/color] of your resolve. 50% of this perk applies to other whips and flails.",
	LegendSpecialistNinetailsSkill = "Practice in the arts of punishment grants greater accuracy with the unwieldy weapon. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] of your resolve as melee skill while using the cat o nine tails. 50% of this perk applies to other whips and flails.",
