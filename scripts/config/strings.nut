...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistNinetailsSkill = "Practice in the arts of punishment grants greater accuracy with the unwieldy weapon. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+20%[/color] of your resolve as melee skill while using the cat o nine tails. 50% of this perk applies to other whips, chains and flails. Does not apply to orc chains. \n[color=#0b0084]From the Ninetails perk group[/color]",
