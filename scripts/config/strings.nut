...
gt.Const.Strings.PerkDescription <- {
	...
	LegendBarterConvincing = "This characters skill with words makes their trade proposals more acceptable. Grants +2.5 barter skill, increasing sell prices, reducing buy prices and increasing pay for delivery contracts. Barter skill begins falling off at higher total rates.  \n[color=#0b0084]From the Barter perk group[/color]",
	LegendBarterTrustworthy = "This characters body language makes people believe them, leading to more favourable trade agreements. Grants +5 barter skill increasing sell prices, reducing buy prices and increasing pay for delivery contracts. Barter skill begins falling off at higher total rates.  \n[color=#0b0084]From the Barter perk group[/color]",
	...
	LegendDrumsOfWar = "Learn powerful rythms that drive your allies on. Unlocks the Drums of War skill that restores [color=" + this.Const.UI.Color.PositiveValue + "]+4[/color] fatigue to every ally on the field. Can only be used with a Drum or Lute equipped. \n[color=#0b0084]From the Bard perk group[/color]",
	...
	LegendGrapple = "Grab your opponent and manhandle them to the ground, inflicting fatigue and grappling them for two turns. Grants the \'Grapple\' ability. \n[color=#0b0084]From the Unarmed perk group[/color]",
	...
	LegendUntouchable = "Staying hidden is about more than just clever disguise, one must be prepared to avoid stray blows and arrows in the heat of battle. Extends your camouflage by one turn. ",
	...
	LegendDrumsOfLife = "Learn powerful rythms that drive your allies on. Unlocks the Drums of Life skill that restores [color=" + this.Const.UI.Color.PositiveValue + "]+3[/color] health to every ally on the field. Can only be used with a Drum or Lute equipped. \n[color=#0b0084]From the Bard perk group[/color]",
	...
	LegendNetRepair = "Many years spent repearing and packing nets allows you to create nets. Unlocks the Net recipe in the crafting tent.",
