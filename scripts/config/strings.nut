...
gt.Const.Strings.PerkDescription <- {
	...
	ReturnFavor = "Unlocks the \'Return Favor\' skill which when active has a [color=" + this.Const.UI.Color.PositiveValue + "]50%[/color] chance to stun any opponent missing a melee attack against this character in retaliation. Immunities and resistances against being stunned still apply. [color=#0b0084]From the Mace perk group[/color]",
	PerfectFocus = "Unlocks the \'Perfect Focus\' skill which allows the use of all other skills for one round at half the normal Action Point cost (rounded down), but 2.5 times the fatigue cost. \n[color=#0b0084]From the Calm perk group[/color]",
	...
	Recover = "Unlocks the \'Recover\' skill which allows for resting a turn in order to reduce accumulated Fatigue by [color=" + this.Const.UI.Color.NegativeValue + "]5.5% [/color]for each action point available. Recover can not be used if another skill is used.[/color]. \n[color=#0b0084]From the Fit perk group[/color]",
	...
	LegendBarterConvincing = "This characters skill with words makes their trade proposals more acceptable. Grants +2.5% barter skill, increasing sell prices, reducing buy prices and increasing pay for delivery contracts.  \n[color=#0b0084]From the Barter perk group[/color]",
	...
	LegendSpecialistKnifeDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]4-12[/color] damage while using a Knife. 25% of this skill applies to other daggers.  \n[color=#0b0084]From the Knife perk group[/color]",
	LegendSpecialistKnifeSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]12[/color] melee skill and [color=" + this.Const.UI.Color.PositiveValue + "]+40%[/color] armor penetration while using a knife. 25% of this skill applies to other daggers.  \n[color=#0b0084]From the Knife perk group[/color]",
	...
	LegendSpecialistWoodaxeDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a Woodaxe or Saw. Only 25% of this skill applies to other axes  \n[color=#0b0084]From the Lumberjack perk group[/color]",
	LegendSpecialistWoodaxeSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill while using a woodaxe or Saw. Only 25% of this skill applies to other axes   \n[color=#0b0084]From the Lumberjack perk group[/color]",
	...
	LegendFavouredEnemyGhoul = "Studying these monstrosities has given you insights into the strengths and weaknesses of the palid necrophilic flesh devourers. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting nachzehrers. Bonus increases the more Nachzehrer you kill.  The bonus depends on how powerful the Nachzehrer is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.1%[/color] per Nachzherer, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.5%[/color] per Skin Ghoul you kill",
	LegendFavouredEnemyHexen = "Understanding the techniques of the malevolent crones gives you protection against their coven.  Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and resolve while fighting hexe. Bonus increases the more Hexe you kill at a rate of [color=" + this.Const.UI.Color.PositiveValue + "]+0.5%[/color] per Hexe you kill. Taking this perk unlocks an difficult legendary contract to hunt a coven leader",
	...
	LegendFavouredEnemyBandit = "Villainous scum, hiding in the dark and stealing from good folk. The bandits must be purged to restore order in the world. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage against bandits. Also increases spawn rate of bandit champions. Bonus increases the more bandits you kill, the rate depends on how powerful the bandit is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.03%[/color] per Bandit Rabble, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.3%[/color] per Bandit Leader you kill",
	...
	LegendBalance = "Some favour heavy armor, others prefer lightweight. A few strive to find the perfect balance protection and movement. Grants up to [color=" + this.Const.UI.Color.PositiveValue + "]+40[/color] bonuse melee defense, ranged defense and % armor damage reduction.  The bonus is at maximum when your current body armor is twice your current initiative. The bonus decreases for every point of difference between the two, to a minimum of 5. \n[color=#0b0084]From the Medium Armor perk group[/color]",
	LegendMatchingSet = "Proper distribution of weight is crucial for maintaining mobility. Grants up to  [color=" + this.Const.UI.Color.PositiveValue + "]5[/color] fatigue per round if your helmet and armor values match. Decreases by 1 for every 10 points difference. Armor that is too heavy can not be balanced, does not work if their combined durality is above 350. \n[color=#0b0084]From the Medium Armor perk group[/color]",
	LegendLithe = "Not as nimble as some, but more lithe than most. Hitpoint damage taken is reduced by up to [color=" + this.Const.UI.Color.PositiveValue + "]30%[/color], but lowered by the total penalty to Maximum Fatigue from body and head armor above 30. Does nothing if you have the Nimble perk. \n[color=#0b0084]From the Medium Armor perk group[/color]",
	...
	LegendOnslaught = "Move with offputting speed, feinting, poking, battering and catching your opponents off gaurd. Grants a [color=" + this.Const.UI.Color.PositiveValue + "]25%[/color] chance to apply daze on every hit with any weapon, when your Initiative and Fatigue are higher than that of your opponent. [color=#0b0084]From the Mace perk group[/color]",
