...
gt.Const.Strings.PerkDescription <- {
	...
	FullForce = "Put your full weight into every blow and gain [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] of your current body armor as additional maximum damage. \n[color=#0b0084]From the Heavy Armor perk group[/color]",
