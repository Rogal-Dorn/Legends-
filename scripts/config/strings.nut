...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistShortbowSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] ranged skill and 25% armor penetration while using a Shortbow Item, such as a Shortbow, Wonky Bow, Boondock Bow, Reinforced Boondock Bow or Composite Bow. Only 25% of this applies to other bows.",
