...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistPickaxeDamage = "Allows this character to mine for minerals while assigned to the Supply Tent in camp. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a pickaxe, or [color=" + this.Const.UI.Color.PositiveValue + "]+1-3[/color] damage when wielding 2 handed hammers.",
