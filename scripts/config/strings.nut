...
gt.Const.Strings.PerkDescription <- {
	...
	LegendMeek = "Being quiet and unassuming can makes enemies underestimate how good you are at cowering and avoiding conflict\n\n Gain a [color=" + this.Const.UI.Color.PositiveValue + "]100%[/color] chance to force an enemy to reroll a failed attack.\n [color=" + this.Const.UI.Color.NegativeValue + "]Lose 1% for every point of Melee Defense and Resolve you have.[/color]",
