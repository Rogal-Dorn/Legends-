...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistButcherDamage = "Gain 10-15 damage while using a Butchers Cleaver. Does not apply to other cleavers.",
	...
	LegendSpecialistHammerSkill = "Gain 15 melee skill and +50% armor damage while using a Blacksmiths Hammer. Does not apply to other hammers.",
