...
gt.Const.Strings.PerkDescription <- {
	...
	LegendKnifeplay = "Unlocks a bound throwing knife skill that does [color=" + this.Const.UI.Color.PositiveValue + "]10-20[/color] damage but has almost no armour penetration and will \'Dazed\' a target on hit.\n Benefits from perks that affect throwing weapons.",
