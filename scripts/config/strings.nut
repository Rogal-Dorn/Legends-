...
gt.Const.Strings.PerkDescription <- {
	...
	LegendValaInscribeWeapon = "Allows the Vala to inscribe rocks with random weapon specific rune sigils while encamped.\n\nPossibilities: accuracy, feeding, power.",
	LegendValaInscribeHelmet = "Allows the Vala to inscribe rocks with random helmet specific rune sigils while encamped.\n\nPossibilities: bravery, clarity, luck.",
	LegendValaInscribeArmor = "Allows the Vala to inscribe rocks with random armor specific rune sigils while encamped.\n\nPossibilities: endurance, resilience, safety.",
	LegendValaInscribeShield = "Allows the Vala to inscribe rocks with random shield specific rune sigils while encamped.\n\nPossibilities: defense.",
