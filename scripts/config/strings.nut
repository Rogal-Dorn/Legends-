...
gt.Const.Strings.PerkDescription <- {
	...
	LegendPerfectFit = "Leverage the superior fit of your armor to gain increased speed and endurance! Reduces the penalty to Initiative from head and body armor by [color=" + this.Const.UI.Color.NegativeValue + "]30%[/color] and lowers the Fatigue cost of skills by [color=" + this.Const.UI.Color.NegativeValue + "]15%[/color]. This bonus is reduced exponentially when the total penalty to Maximum Fatigue from your head and body armor is more than half of your Maximum Fatigue after gear.",
