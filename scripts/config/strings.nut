...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecCultArmor = "Pain is the embrace of God, our bodies keep us from bliss. Only in suffering can we know truth.  Gain [color=" + this.Const.UI.Color.PositiveValue + "]+75%[/color] of your missing health as resolve, while wearing cultist robes, sackcloth, barbarian hide, bone armour, warlock robes or leather wraps. Adds [color=" + this.Const.UI.Color.PositiveValue + "]+10[/color] health. \n Also unlocks a crafting recipe to make cultist robes.",
