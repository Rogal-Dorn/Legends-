...
gt.Const.Strings.PerkDescription <- {
	...
	LegendGrapple = "Grab your opponent and manhandle them to the ground, inflicting fatigue and stunning them for a round. Grants the \'Grapple\' ability, which can only be used with your offhand free. \n[color=#0b0084]From the Unarmed perk group[/color]",
