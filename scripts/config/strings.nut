...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistShortbowSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] ranged skill and [color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color] armor penetration while using a Shortbow Item, such as a Shortbow, Wonky Bow, Boondock Bow, Reinforced Boondock Bow or Composite Bow. Only 25% of this applies to other bows.",
	...
	LegendSpecialistScytheSkill = "Practicing with the unwieldy scythe has taught you how to twist your torso to produce repeatable smooth strokes. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+15[/color] melee skill and [color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color] armor damage while wielding a Scythe or Warscythe.",
	...
	LegendForcefulSwing = "Use the power of your hips and core to imbue more force into your swings. Melee AOE skills do [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] damage.",
