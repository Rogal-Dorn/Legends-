...
gt.Const.Strings.PerkDescription <- {
	...
	LegendValaChantFury = "A chant that really gets the blood boiling, making your allies excited about going into battle.\n\nAllies within 3 tiles of the Vala, including the Vala herself, receive a bonus to their damage output and a chance to retaliate against melee attackers that hit them.",
