...
gt.Const.Strings.PerkDescription <- {
	...
	LegendDrumsOfWar = "Learn powerful rythms that drive your allies on. Unlocks the Drums of War skill that restores [color=" + this.Const.UI.Color.PositiveValue + "]+4[/color] fatigue to every ally within 3 tiles. Can only be used with a Drum or Lute equipped. \n[color=#0b0084]From the Bard perk group[/color]",
	...
	LegendDrumsOfLife = "Learn powerful rythms that drive your allies on. Unlocks the Drums of Life skill that restores [color=" + this.Const.UI.Color.PositiveValue + "]+3[/color] health to every ally within 3 tiles Can only be used with a Drum or Lute equipped. \n[color=#0b0084]From the Bard perk group[/color]",
