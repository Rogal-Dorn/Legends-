...
gt.Const.Strings.PerkDescription <- {
	...
	LegendToolsSpares = "Your experience with repairs has taught you to save your scraps and left over parts. These spares take up little space but are often just what you need for field repairs. Increases maximum tool storage by [color=" + this.Const.UI.Color.PositiveValue + "]20[/color], reduces tool usage by [color=" + this.Const.UI.Color.PositiveValue + "] 6% [/color] and increases Stamina by [color=" + this.Const.UI.Color.PositiveValue + "]+3[/color].  \n[color=#0b0084]From the Repair perk group[/color]",
	...
	LegendNetRepair = "Many years spent repearing and packing nets allows you to create nets and wield them more effectively. Unlocks the Net recipe in the crafting tent. Also grants +25% chance to hit with nets and grants 10 melee defense while holding a net.",
