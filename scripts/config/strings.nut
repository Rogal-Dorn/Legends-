...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistPitchforkDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Pitchfork, Wooden Pitchfork, Hoe, Scythe or Wooden Flail. 35% of this perk applies to other polearms including banners.",
	...
	LegendSpecialistShortbowDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a shortbow, wonky bow or boondock bow. Only 35% of this skill applies to other bows.",
	...
	LegendSpecialistWoodaxeDamage = "Allows this character to harvest wood while gathering in camp. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Woodcutter\'s Axe or Saw. Only 35% of this skill applies to other axes.",
	...
	LegendSpecialistSlingDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a sling.\n[color=" + this.Const.UI.Color.PositiveValue + "]+15-30[/color] damage while using a slingstaff at range (but increases the AP cost of Sling Heavy Stone by 1 and Fatigue cost by 4)..",
	LegendSpecialistSlingSkill = "Gain[color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] ranged skill and [color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color] armor damage while using a sling.\n[color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] ranged skill and [color=" + this.Const.UI.Color.PositiveValue + "]+50%[/color] armor damage while using a slingstaff at range (but increases the AP cost of Sling Heavy Stone by 1 and Fatigue cost by 4)..",
