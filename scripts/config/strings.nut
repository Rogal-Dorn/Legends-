...
gt.Const.Strings.PerkDescription <- {
	...
	LegendFavouredEnemyAlps = "Preparing for the nightmare creepers gives you techniques against their haggard curses.  Grants bonus to melee skill, ranged skill and maximum damage. Bonus increases the more Alps you kill.",
	LegendFavouredEnemyUnhold = "These gigantic ravenous creatures are dangerous but stupid, that can be used to your advantage. Grants bonus to melee skill, ranged skill and maximum damage. Bonus increases the more Unholds you kill.",
	LegendFavouredEnemyLindwurm = "Understanding the morphology of these noxious serpents opens up weak spots in their scales. Grants bonus to melee skill, ranged skill and maximum damage. Bonus increases the more Lindwurm you kill.",
	...
	LegendFavouredEnemySpider = "These skittering deadly bugs can be bested by studying the behaviour of arachnids. Grants bonus to melee skill, ranged skill and maximum damage. Bonus increases the more Spiders you kill.",
	LegendFavouredEnemySchrat = "The strong branches of a living tree are deadly foes, but trees can be felled with the right knowledge. Grants bonus to melee skill, ranged skill and maximum damage. Bonus increases the more Schrats you kill. ",
