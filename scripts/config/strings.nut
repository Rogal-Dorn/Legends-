...
gt.Const.Strings.PerkDescription <- {
	...
	Stalwart = "Grants passive immunity against being knocked back or pulled up close. Applies to skills such as Knock Back, Hook and others that change a character\'s position. Does not grant the damage reduction of indomitable, but also doesn\'t require activation.",
