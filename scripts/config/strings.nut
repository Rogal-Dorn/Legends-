...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpawnZombieLow = "Raise a half-formed thrall from a pile of mismatched dead flesh. Though lacking in strength or bodily integrity, it shall obey. Requires 15 health to summon and 1 human carrion. Taking this perk grants +20 health.",
	LegendSpawnZombieMed = "Organize the remains before you raise it so that your creation is better suited to the work it is given. Sturdier in both form and function. Requires 20 health to summon and 1 human carrion. Taking this perk adds 30 medicine to your stash and increases the total medicine by 30.",
	LegendSpawnZombieHigh = "Stitch the body together with such precision so that, once raised, it could pass as alive. A magnum opus of flesh, unsurpassed in power. Requires 30 health to summon and 1 human carrion.",
