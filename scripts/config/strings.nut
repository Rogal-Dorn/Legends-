...
gt.Const.Strings.PerkDescription <- {
	...
	BattleFlow = "Glide through battle like a leaf in a stream.\n\nOnce per turn, killing an opponent reduces current fatigue by [color=" + this.Const.UI.Color.NegativeValue + "]-10%[/color] of the base maximum fatigue (before penalties due to armor are applied).",
