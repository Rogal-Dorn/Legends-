...
gt.Const.Strings.PerkDescription <- {
	...
	LegendFieldTriage = "Spend medicine to heal a unit on the battlefield, at a rate of 1 medicine for every 2 health. \n[color=#0b0084]From the Healing perk group[/color]",
	LegendFieldRepairs = "Spend armor parts to repair armor on the battlefield, at a rate of 1 tool for every 5 durability.  \n[color=#0b0084]From the Repair perk group[/color]",
