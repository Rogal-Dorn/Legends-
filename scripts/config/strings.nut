...
gt.Const.Strings.PerkDescription <- {
	...
	LegendCheerOn = "Use your way with song to cheer on an ally. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+2[/color] Action Points to an ally within three tiles. Costs 4 Action Points to perform. Can only be used with an Instrument or Banner equipped.",
