...
gt.Const.Strings.PerkDescription <- {
	...
	TrophyHunter = "Each fight tells a story, with glory and strength growing in their end. Gain one hitpoint for every enemy you kill",
	Bruiser = "Intense weight training has led your attacks to inflict more damage against armor. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] damage against armor on all attacks",
	...
	LegendGatherer = "Knowledge of the landscape and vegetation provides a wealth of opportunities when gathering in camp. Apocatheries usualy gain their level as a percentage reduction in hours required to find special items. This skill doubles that bonus to twice their level. When the total bonus from all apocatheries is above 10%, they can also find mushrooms, poisons, antidotes and powders",
