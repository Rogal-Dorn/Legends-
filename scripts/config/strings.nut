...
gt.Const.Strings.PerkDescription <- {
	...
	LegendClarity = "A well honed mind can perceive more in each instant, making time appear slower in key instants of need. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+1[/color] Action Point, but all fatigue costs are increased by [color=" + this.Const.UI.Color.NegativeValue + "]+20%[/color] . Does not work if you have Berserk or are dazed, drunk, hungover, taunted, staggered, horrified, concused or fleeing. Gain an additional [color=" + this.Const.UI.Color.PositiveValue + "]+1[/color] Action Point and [color=" + this.Const.UI.Color.NegativeValue + "]+20%[/color] fatigue cost if under the effect of potions that improve cognition: Iron Will, Lionheart, Cat, Recovery or Hexen Ichor. \n[color=#0b0084]From the Calm perk group[/color]",
	...
	LegendNetRepair = "Many years spent repearing and packing nets allows you to create nets and wield them more effectively. Unlocks the Net recipe in the crafting tent. Also grants +10 melee defense while holding a net.",
