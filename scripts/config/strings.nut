...
gt.Const.Strings.PerkDescription <- {
	...
	LegendFavouredEnemySoutherner = "The southern city states are horrific, their slavery and conscription are afronts to human dignity. Their power must be over thrown. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while southerners. Bonus increases the more southerners you kill. This includes Gunners, Officers, Engineers, Assassins, Conscripts, and more.  The bonus depends on how powerful the southerner is, between [color=" + this.Const.UI.Color.PositiveValue + "]+0.08%[/color] per Conscript, and [color=" + this.Const.UI.Color.PositiveValue + "]+0.4%[/color] per Veteran Manhunter you kill",
	...
	LegendPacifist = "Fighting is a brutal thuggish pastime, most folk prefer a life without frequent bouts of extreme violence.  This character does not count towards your party strength when determining game difficulty. The will gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] resolve. They become content with being in reserve, and will grow unhappy if they are placed in battle more than once per week. [color=#0b0084]From the Organised perk group[/color]",
