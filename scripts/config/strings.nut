...
gt.Const.Strings.PerkName <- {
	...
	LegendBribe = "Bribe",
	LegendsOffBookDeal = "Off-Book Deal",
	Stalwart = "Stalwart",
	Steadfast = "Steadfast",
	Rebound = "Rebound",
	Feint = "Feint",
...
gt.Const.Strings.PerkDescription <- {
	...
	LegendBarterGreed = "Lust for gold and self interest can be a double edged sword, an immediate benefit in one place, may come at the expense of others. \n\n[color=#4f1800][u]Passive:[/u][/color]\n• Gain [color=" + this.Const.UI.Color.PositiveValue + "]0.14% of your crowns[/color] as Melee Skill and Ranged Skill\n• Gain [color=" + this.Const.UI.Color.PositiveValue + "]0.16% of your crowns[/color] as Resolve\n• Gain [color=" + this.Const.UI.Color.PositiveValue + "]0.07% of your crowns[/color] as Melee Defence and Ranged Defence\n\nYour global Barter is divided by [color=" + this.Const.UI.Color.NegativeValue + "](1 + Brothers with this perk)[/color] at all times.",
