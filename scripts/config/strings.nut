...
gt.Const.Strings.PerkDescription <- {
	...
	LegendMedIngredients = " earning the plants of the healing trade allows you to fashion crude healing supplies from common ingredients. Unlocks crafting bandages and medicine. Also increases maximum medicine storage by 10.  \n[color=#0b0084]From the Healer perk group[/color]",
