...
gt.Const.Strings.PerkDescription <- {
	...
	LegendRoster5 = "Oversee the section\'s financial administration processes, managing pay disputes, disbursements, withholdings and loans.  Increases the company roster size by [color=" + this.Const.UI.Color.PositiveValue + "]4[/color]",
	LegendRoster6 = "Manage the company logistics. Supply rationing, camp structure and waste disposal. Increases the company roster size by [color=" + this.Const.UI.Color.PositiveValue + "]5[/color]",
	...
	LegendValaInscriptionMastery = "Lowers the cooldown until the Vala can begin inscribing rune sigils again (after a successful inscription) from 20 to 15 days, and increases her inscription speed from 4 to 5.5 tries per day.",
	LegendValaInscribeWeapon = "Allows the Vala to inscribe rocks with random weapon specific rune sigils. Her first inscription happens automatically when you learn this perk, but the rest of the time the game checks 4 times per day to see if an inscription is successful.\n\nPossibilities: accuracy, feeding, power\n\nUpon success, she needs to wait 20 days before she can begin inscribing rocks with these rune sigils again.",
	LegendValaInscribeHelmet = "Allows the Vala to inscribe rocks with random helmet specific rune sigils. Her first inscription happens automatically when you learn this perk, but the rest of the time the game checks 4 times per day to see if an inscription is successful.\n\nPossibilities: bravery, clarity, luck\n\nUpon success, she needs to wait 20 days before she can begin inscribing rocks with these rune sigils again.",
	LegendValaInscribeArmor = "Allows the Vala to inscribe rocks with random armor specific rune sigils. Her first inscription happens automatically when you learn this perk, but the rest of the time the game checks 4 times per day to see if an inscription is successful.\n\nPossibilities: endurance, resilience, safety\n\nUpon success, she needs to wait 20 days before she can begin inscribing rocks with these rune sigils again.",
	LegendValaInscribeShield = "Allows the Vala to inscribe rocks with random shield specific rune sigils. Her first inscription happens automatically when you learn this perk, but the rest of the time the game checks 4 times per day to see if an inscription is successful.\n\nPossibilities: defense\n\nUpon success, she needs to wait 20 days before she can begin inscribing rocks with these rune sigils again.",
	...
	LegendValaTrancePerspective = "Incorporeal Perspective.",
	LegendValaTranceMalevolent = "The spirit world is home to many malevolent beings, and the Vala knows how to contact them. Once her access to their realm has been established, she calls upon these ill-willed spirits in hopes of receiving their help. If she\'s successful, these spirits will harass, torment and weaken her foes.",
	...
	LegendValaSpiritualBond = "The bond between the Vala and her Warden has grown strong with the passing of time. A percentage of the Vala\'s incoming health damage is dealt to the Warden instead, based on the Vala\'s Resolve and up to a maximum of 50%.\n\nThis perk does nothing unless the Vala has the Warden perk.",
	...
	LegendBarterConvincing = "This characters skill with words makes their trade proposals more acceptable. Grants +5% barter",
	LegendBarterTrustworthy = "This characters body language makes people believe them, leading to more favourable trade agreements. Grants +10% barter",
