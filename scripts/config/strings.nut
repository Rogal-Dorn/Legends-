...
gt.Const.Strings.PerkDescription <- {
	...
	LegendBalance = "Some favour heavy armor, others prefer lightweight. A few strive to find the perfect balance of protection and movement. Grants up to [color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color] defense reroll chance.  The bonus is at maximum when your current body armor is twice your current initiative. The bonus decreases for every point of difference between the two, to a minimum of 5. \n[color=#0b0084]From the Medium Armor perk group[/color]",
	...
	LegendLithe = "Not as nimble as some, but more lithe than most. Hitpoint damage taken is reduced by up to [color=" + this.Const.UI.Color.PositiveValue + "]30%[/color], but lowered by the total penalty to Maximum Fatigue from body and head armor above 40. Does nothing if you have the Nimble or Battleforged perks. \n[color=#0b0084]From the Medium Armor perk group[/color]",
	LegendHidden = "Master the art of concelement. Blend in with your surroundings and remain hidden from the enemy for 3 turns, or until your next attack \n[color=#0b0084]From the Devious perk group[/color]",
	...
	LegendSmackdown = "Use your size and strength to bully your way into the prime position. Gain a [color=" + this.Const.UI.Color.PositiveValue + "]25%[/color] chance to Knockback any opponent on any attack where you have more health and fatigue than them. \n[color=#0b0084]From the Hammer perk group[/color]",
	...
	PushTheAdvantage = "Strike hardest where they are weakest. When attacking a sleeping, stunned, netted, dazed, staggered or grappled enemy, gain [color=" + this.Const.UI.Color.PositiveValue + "]+20[/color] Melee and Ranged skill, and [color=" + this.Const.UI.Color.PositiveValue + "]+20%[/color] chance to hit the head",
	LegendMindOverBody = "Push your body beyond what is humanly possible through your sheer force of will. Spend less fatigue on skills for each point of Resolve over 60. Does not stack with Spearwaller or Weapon masteries. \n[color=#0b0084]From the Intelligent perk group[/color]",
	...
	LegendSummonBear = "Endless communion with the animals has won you the trust of the bears. Adds a pet bear to your stash, make sure you have space before taking this perk",
