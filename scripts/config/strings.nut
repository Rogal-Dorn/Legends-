...
gt.Const.Strings.PerkDescription <- {
	...
	LegendHoldTheLine = "Direct your troops to stand their ground, granting [color=" + this.Const.UI.Color.PositiveValue + "]+10[/color] melee defence, reducing damage taken by [color=" + this.Const.UI.Color.PositiveValue + "]10%[/color] and granting immunity to being moved to all allies within [color=" + this.Const.UI.Color.PositiveValue + "]4[/color] tiles for one turn.",
	...
	LegendFieldTriage = "Spend medicine to heal a unit on the battlefield, at a rate of 1 medicine for every 2 health. Heals up to [color=" + this.Const.UI.Color.PositiveValue + "]40[/color] health per use ",
