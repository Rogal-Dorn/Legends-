...
gt.Const.Strings.PerkDescription <- {
	...
	vazl_ValaInscriptionMastery = "Lowers the cooldown until the Vala can begin creating rune sigils again (after a successful rune sigil creation) from 20 to 15 days, and increases her inscription speed from 4 to 5.5 tries per day.",
