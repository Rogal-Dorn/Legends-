...
gt.Const.Strings.PerkDescription <- {
	...
	LegendBarterGreed = "Lust for gold and self interest can be a double edged sword, an immediate benefit in one place, may come at the expense of others. Gain increased melee skill, ranged skill, resolve, melee defence and ranged defence based on how much gold your company has in its stash. There is no upper limit to the effectiveness of this perk and will continue to scale.",
