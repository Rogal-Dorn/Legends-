...
gt.Const.Strings.PerkDescription <- {
	...
	FullForce = "Put your full weight into defending every blow and gain [color=" + this.Const.UI.Color.PositiveValue + "]+10%[/color] of the combined fatigue modifier from body, head, main hand and off hand as Melee Defense. \n[color=#0b0084]From the Heavy Armor perk group[/color]",
