...
gt.Const.Strings.PerkDescription <- {
	...
	LegendSpecialistButcherDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Butcher Knife Item, such as the Butcher\'s Cleaver. 35% of this skill applies to One Handed Cleavers, but not Whips.",
	LegendSpecialistButcherSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill while using a Butcher Knife Item, such as the Butcher\'s Cleaver. 25% of this skill applies to One Handed Cleavers, but not Whips.",
	LegendSpecialistHammerDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Blacksmith Hammer Item, such as the Blacksmith\'s Hammer. 35% of this skill applies to other One Handed Hammers.",
	LegendSpecialistHammerSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill and [color=" + this.Const.UI.Color.PositiveValue + "]+40%[/color] armor damage while using a Blacksmith Hammer Item, such as the Blacksmith\'s Hammer. 25% of this skill applies to other One Handed Hammers.",
	LegendSpecialistKnifeDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Knife Item, such as a Knife or Shiv. 35% of this skill applies to other daggers.",
	LegendSpecialistKnifeSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill and [color=" + this.Const.UI.Color.PositiveValue + "]+40%[/color] armor penetration while using a Knife Item, such as a Knife or Shiv. 25% of this skill applies to other daggers.",
	...
	LegendSpecialistMilitiaDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Militia Item, such as a Militia Spear, Ancient Spear or Wooden Spear. Only 35% of this skill applies to other spears.",
	LegendSpecialistMilitiaSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill while using a Militia Item, such as a Militia Spear, Ancient Spear or Wooden Spear. Only 25% of this skill applies to other spears.",
	LegendSpecialistPickaxeDamage = "Allows this character to mine for minerals while assigned to the Supply Tent in camp. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a Pickaxe Item, such as a Pickaxe, or [color=" + this.Const.UI.Color.PositiveValue + "]+2-7[/color] damage when wielding Two Handed Hammers.",
	LegendSpecialistPickaxeSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill while using a Pickaxe Item, such as a Pickaxe, or [color=" + this.Const.UI.Color.PositiveValue + "]+3[/color] melee skill while using Two Handed Hammers.",
	...
	LegendSpecialistShovelDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Shovel Item, such as a Shovel. 35% of this skill applies to Two Handed Maces.",
	LegendSpecialistShovelSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill and gain the \'Knock Out\' skill while using a Shovel Item, such as a Shovel. 25% of this bonus melee skill applies to Two Handed Maces.",
	LegendSpecialistWoodaxeDamage = "Allows this character to harvest wood while gathering in camp. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+9-24[/color] damage while using a Woodaxe Item, such as a Woodcutter\'s Axe or Handsaw. Only 35% of this skill applies to other Axes.",
	LegendSpecialistWoodaxeSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill while using a Woodaxe Item, such as a Woodcutter\'s Axe or Handsaw. Only 25% of this bonus melee skill applies to other Axes.",
	LegendSpecialistSickleDamage = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+6-16[/color] damage while using a Sickle Item, such as a Sickle or Notched Blade. Only 25% of this bonus melee skill applies to other One Handed Swords.",
	LegendSpecialistSickleSkill = "Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill and [color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color] armor piercing while using a Sickle Item, such as a Sickle or Notched Blade. 25% of this skill applies to One Handed Swords.",
	...
	LegendSpecialistScytheSkill = "Practicing with the unwieldy scythe has taught you how to twist your torso to produce repeatable smooth strokes. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+15[/color] melee skill while wielding a Scythe Item, such as Scythe or Warscythe.",
	LegendSpecialistScytheDamage = "There is a trick to sharpening the blades of scythes, and shifting the position of the handles turns it from a farming tool into a weapon. Mastering these tricks increases the damage output of Scythe Items, such as Scythes and Warscythes, by [color=" + this.Const.UI.Color.PositiveValue + "]+10-15[/color]",
