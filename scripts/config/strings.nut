...
gt.Const.Strings.PerkDescription <- {
	...
	ReturnFavor = "Unlocks the \'Return Favor\' skill which when active has a [color=" + this.Const.UI.Color.PositiveValue + "]75%[/color] chance to stun and stagger any opponent missing a melee attack against this character in retaliation. Immunities and resistances against being stunned still apply.",
	...
	BattleFlow = "Once per turn, killing an opponent reduces current fatigue by [color=" + this.Const.UI.Color.NegativeValue + "]-10%[/color] of the base maximum fatigue (before penalties due to armor are applied).",
	...
	LegendSpawnZombieLow = "Raise a half-formed thrall from a pile of mismatched dead flesh. Though lacking in strength or bodily integrity, it shall obey. Requires 15 health to summon and 1 human carrion. Taking this perk grants +10 health.",
	LegendSpawnZombieMed = "Organize the remains before you raise it so that your creation is better suited to the work it is given. Sturdier in both form and function. Requires 25 health to summon and 1 human carrion. Taking this perk adds 30 medicine to your stash and increases the total medicine by 30.",
	LegendSpawnZombieHigh = "Stitch the body together with such precision so that, once raised, it could pass as alive. A magnum opus of flesh, unsurpassed in power. Requires 35 health to summon and 1 human carrion.",
	...
	LegendBribe = "Throw coins at your enemies to bribe them away from battle, only works on humans. The cost is the XP that would be granted by killing the enemy, to the power of 1.3.",
	...
	LegendSpecialistPickaxeDamage = "Allows this character to mine for materials while assigned to gather in camp, and provides a small chance to harvest gems when smashing rocks in battle. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+4-12[/color] damage while using a pickaxe, or [color=" + this.Const.UI.Color.PositiveValue + "]+1-3[/color] damage when wielding 2 handed hammers.",
	LegendSpecialistPickaxeSkill = " Allows Pickaxes and hammers to crush rocks in battle. Gain [color=" + this.Const.UI.Color.PositiveValue + "]+12[/color] melee skill while using a pickaxe, or [color=" + this.Const.UI.Color.PositiveValue + "]3[/color] melee skill while using 2 handed hammers.",
	...
	LegendSpecialistNinetailsDamage = "Use your strength of will to turn the tips of the cattail to inflict horrible injuries. While wielding a cat of nine tails this skill increases damage by [color=" + this.Const.UI.Color.PositiveValue + "]+5-10%[/color] of your resolve. 50% of this perk applies to other whips, chains and flails, except the three-headed flail and berserker chain. \n[color=#0b0084]From the Ninetails perk group[/color]",
	LegendSpecialistNinetailsSkill = "Practice in the arts of punishment grants greater accuracy with the unwieldy weapon. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+20%[/color] of your resolve as melee skill while using the cat o nine tails. 50% of this perk applies to other whips, chains and flails, except the three headed flail and berserker chain. \n[color=#0b0084]From the Ninetails perk group[/color]",
	...
	LegendFavouredEnemyVampire = "The terrifying abilities of the Necrosavants and Embalmed are developed over time beyond memory. Their techniques are honed to perfection, but that also makes them predictable. Grants [color=" + this.Const.UI.Color.PositiveValue + "]+5%[/color] bonus to melee skill, ranged skill and maximum damage while fighting Necrosavants and Embalmed. Bonus increases at a rate of [color=" + this.Const.UI.Color.PositiveValue + "]+0.3% to +0.4%[/color] per necrosavant or Embalmed killed.",
	...
	LegendSpecCultHood = "In Pain we find the truth of ourselves. We have no identity beyond servitude, our glory is agony. While your face is obscured by a cultist hood, gain [color=" + this.Const.UI.Color.PositiveValue + "]+25%[/color] of your base resolve as a bonus to melee and ranged defense. Also works with cultist leather hood, leather helmet, decayed sack helm, warlock hood or mask of davkul",
	LegendSpecCultArmor = "Pain is the embrace of God, our bodies keep us from bliss. Only in suffering can we know truth.  Gain [color=" + this.Const.UI.Color.PositiveValue + "]+75%[/color] of your missing health as resolve, while wearing cultist robes, sackcloth, barbarian hide, bone armour, warlock robes or leather wraps",
	...
	LegendBarterGreed = "Lust for gold and self interest can be a double edged sword, an immediate benefit in one place, may come at the expense of others. Gain 7.5% barter, but divide all sources of barter bonus by 1 + the number of mercenaries with this perk.",
	...
	LegendPrayerOfFaith = "A prayer of devotion grants strength to your allies and baffles the undead. Adjacent allies gain [color=" + this.Const.UI.Color.PositiveValue + "]+20%[/color] of their resolve as Melee and Ranged Defense. Adjacent undead are Baffled. Does not work on cultists.",
	...
	LegendTumble = "Make use of your acrobatic skill to improve your movements. Halves the Fatigue Cost of Lunge, Unarmed Lunge, Footwork and Leap. The Action Point cost of all these skills is reduced by [color=" + this.Const.UI.Color.PositiveValue + "]1[/color], except that of Leap which is halved instead.",
