...
gt.Const.Strings.PerkDescription <- {
	...
	LegendAdaptive = "Who says you can\'t teach an old dog new tricks?\n\nAdd a new Perk Group to this character\'s Perk Tree. The Perk Group is determined by what is currently equipped in their hands.\n\n1. Mainhand items will always be checked first, giving priority to Specialist Classes before Weapon Perk Groups. For Hybrid Weapons, the character will be given the Perk Group they do not have, or be given one randomly from the applicable Weapon Types if they have neither.\n2. Offhand items will be checked next\n3. If no items are equipped, they will gain the Unarmed Perk Group if they do not have it.\n4. If the character has all the Perk Groups of their equipped items, they will be given a random Trait Perk Group they do not have.",
