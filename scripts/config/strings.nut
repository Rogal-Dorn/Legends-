...
gt.Const.Strings.PerkDescription <- {
	...
	HoldOut = "Keep it together! Any negative status effect with a finite duration (e.g. Bleeding, Charmed) has its duration reduced by [color=" + this.Const.UI.Color.NegativeValue + "]-5[/color] turns, to a minimum of 1 turn. Also grants [color=" + this.Const.UI.Color.PositiveValue + "]+6[/color] hitpoints \n[color=#0b0084]From the Tenacious perk group[/color]",
	...
	CloseCombatArcher = "If you can see the white in your enemy\'s eyes, aim for it! Damage is increased by a percentage equal to your current Ranged Defense when using a ranged weapon (including throwing weapons) against a target 2 or less tiles away. \n[color=#0b0084]From the Throwing perk group[/color]",
