...
gt.Const.Strings.PerkDescription <- {
	...
	LegendValaInscriptionMastery = "The Vala becomes a master at inscribing the intricate and subtle signs\n\n[color=#4f1800][u]Passive:[/u][/color]\n• Increases the Vala's inscribing speed by [color=" + this.Const.UI.Color.PositiveValue + "]30%[/color].",
	...
	LegendRecuperation = "Heal more effectively over time.\n\n[color=#4f1800][u]Passive:[/u][/color]\n• Heal [color=" + this.Const.UI.Color.PositiveValue + "]+2[/color] Hitpoints and Fatigue at the end of every turn.",
