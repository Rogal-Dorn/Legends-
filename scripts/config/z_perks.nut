...
gt.Const.Perks.PerksTreeCrusader <- [
	...
	[
		...
		},
		{
			...
			IconDisabled = "ui/perks/fullforce56_circle_sw.png"
		},
		{
...
gt.Const.Perks.PerksTreeNecromancer <- [
	...
	[
		...
		},
		{
			...
			Name = this.Const.Strings.PerkName.Lookout,
			Tooltip = this.Const.Strings.PerkDescription.Lookout,
			Icon = "ui/perks/lookout56.png",
			IconDisabled = "ui/perks/lookout56_bw.png"
		},
		{
			ID = "perk.legend_roster_3",
			Script = "scripts/skills/perks/perk_legend_roster_3",
...
gt.Const.Perks.PerksTreeNoble <- [
	...
	[
		...
		},
		{
			...
			Name = this.Const.Strings.PerkName.SpecBandage,
			Tooltip = this.Const.Strings.PerkDescription.SpecBandage,
	...
	[
		...
		},
		{
			...
			Script = "scripts/skills/perks/legend_hold_the_line",
...
for( local row = 0; row < this.Const.Perks.PerksTreeSeer.len(); row = ++row )
{
	for( local i = 0; i < this.Const.Perks.PerksTreeSeer[row].len(); i = ++i )
	{
		local perk = this.Const.Perks.PerksTreeSeer[row][i];
		perk.Row <- row;
		perk.Unlocks <- row;
...
for( local row = 0; row < this.Const.Perks.PerksTreeCrusader.len(); row = ++row )
{
	for( local i = 0; i < this.Const.Perks.PerksTreeCrusader[row].len(); i = ++i )
	{
		local perk = this.Const.Perks.PerksTreeCrusader[row][i];
		perk.Row <- row;
		perk.Unlocks <- row;
...
for( local row = 0; row < this.Const.Perks.PerksTreeRanger.len(); row = ++row )
{
	for( local i = 0; i < this.Const.Perks.PerksTreeRanger[row].len(); i = ++i )
	{
		local perk = this.Const.Perks.PerksTreeRanger[row][i];
		perk.Row <- row;
		perk.Unlocks <- row;
...
for( local row = 0; row < this.Const.Perks.PerksTreeNecromancer.len(); row = ++row )
{
	for( local i = 0; i < this.Const.Perks.PerksTreeNecromancer[row].len(); i = ++i )
	{
		local perk = this.Const.Perks.PerksTreeNecromancer[row][i];
		perk.Row <- row;
		perk.Unlocks <- row;
...
for( local row = 0; row < this.Const.Perks.PerksTreeBerserker.len(); row = ++row )
{
	for( local i = 0; i < this.Const.Perks.PerksTreeBerserker[row].len(); i = ++i )
	{
		local perk = this.Const.Perks.PerksTreeBerserker[row][i];
		perk.Row <- row;
		perk.Unlocks <- row;
...
for( local row = 0; row < this.Const.Perks.PerksTreeNoble.len(); row = ++row )
{
	for( local i = 0; i < this.Const.Perks.PerksTreeNoble[row].len(); i = ++i )
	{
		local perk = this.Const.Perks.PerksTreeNoble[row][i];
		perk.Row <- row;
		perk.Unlocks <- row;
