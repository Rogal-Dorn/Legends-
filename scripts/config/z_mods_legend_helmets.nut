...
gt.Const.LegendMod.HelmetObjs <- [{
    ...
    Script = "",
    Sets = [{
    Hoods = [ //avg 80 need 200, goto tops
        [0, "hood/legend_helmet_barb_chain_scarf"], //55
        [0, "hood/legend_helmet_rotten_chain_scarf"], //60
        [0, "hood/legend_helmet_cloth_scarf"], //10
        [0, "hood/legend_helmet_cloth_bandana"], //15
    ...
    Helms = [ //10 over, maybe remove chain_hood_full? raise chain scarf to 80% avg hoods now ~72, roughly = dura
        [0, "helm/legend_helmet_crude_metal_helm"], //65
        [0, "helm/legend_helmet_crude_cylinder_helm"], //110
        [0, "helm/legend_helmet_heavy_plate_helm"], //170
        [0, "helm/legend_helmet_heavy_plate_helm_named"], //170
    ...
    Tops = [ //avg of around 85 want 120 for helms
        [0, "top/legend_helmet_leather_hood_barb"], //105
        [0, "top/legend_helmet_nose_plate"], //15
        [0, "top/legend_helmet_headband_side"], //20
        [0, "top/legend_helmet_headband_nose"], //30
