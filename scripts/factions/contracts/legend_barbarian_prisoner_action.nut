this.legend_barbarian_prisoner_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onUpdate( _faction )
	{
		...
		local minResources = this.Const.World.LegendaryContract.BarbPrison * contractCosts.BARB_PRISON + contractCosts.BARB_PRISON;
		
		local currentResources = this.m.DifficultyMult * this.getReputationToDifficultyMult * contractCosts.BARB_PRISON;
