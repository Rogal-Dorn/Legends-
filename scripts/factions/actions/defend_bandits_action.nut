this.defend_bandits_action <- this.inherit("scripts/factions/faction_action", {
	...
	function onExecute( _faction )
	{
		...
		{
			local party = this.getFaction().spawnEntity(spawnpoints[i], "Brigands", false, this.Const.World.Spawn.BanditDefenders, this.m.Settlement.getResources() * 0.660000026);
