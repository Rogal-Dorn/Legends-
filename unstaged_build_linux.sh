...
while read -r line; do
    ...
    if [ $x == "M" ] || [ $x == "A" ]; then
        ...
        if [[ "$xpath" == *.sh ]]; then
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legend_enemies.brush" "../$RepoDir/unpacked/legend_enemies")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legend_weapons.brush" "../$RepoDir/unpacked/legend_weapons")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legend_characters.brush" "../$RepoDir/unpacked/legend_characters")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legend_objects.brush" "../$RepoDir/unpacked/legend_objects")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legends_ui.brush" "../$RepoDir/unpacked/legends_ui")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legend_world.brush" "../$RepoDir/unpacked/legend_world")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
            ...
            cd ../bin
            o=$(wine ./bbrusher.exe pack --gfxPath "../$RepoDir/" "../$RepoDir/brushes/legend_runed.brush" "../$RepoDir/unpacked/legend_runed")
            cd "../$RepoDir"
            checkForError "$o" "$i"
            copyBrushes
...
cd ../bin
o=$(./masscompile.sh "$BBDir/scripts")
cd "$RepoDir"
