...
this.legend_armor_reinforced_worn_mail_shirt <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function updateVariant()
	{
		...
		this.m.Icon = "legend_armor/chain/legend_armor_reinforced_worn_mail_shirt" + "_" + variant + ".png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/chain/icon_legend_armor_reinforced_worn_mail_shirt" + "_" + variant + ".png";
		this.m.OverlayIconLarge = "legend_armor/chain/inventory_legend_armor_reinforced_worn_mail_shirt" + "_" + variant + ".png";
	}
});
