...
this.legend_gambeson_wolf <- this.inherit("scripts/items/legend_armor/legend_armor", {
	...
	function updateVariant()
	{
		...
		this.m.IconLarge ="legend_helmets/cloth/inventory_legend_gambeson_wolf" + "_" + variant + ".png"
		this.m.Icon = "legend_helmets/cloth/icon_legend_gambeson_wolf" + "_" + variant + ".png"
	}
});
