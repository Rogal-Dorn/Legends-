...
this.legend_hide_and_bone_armor <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function create()
	{
		...
		this.m.ID = "legend_armor.body.legend_hide_and_bone_armor";
	...
	function updateVariant()
	{
		...
		this.m.Icon = "legend_armor/plate/legend_hide_and_bone_armor" + "_" + variant + ".png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/plate/icon_legend_hide_and_bone_armor" + "_" + variant + ".png";
		this.m.OverlayIconLarge = "legend_armor/plate/inventory_legend_hide_and_bone_armor" + "_" + variant + ".png";
	}
});
