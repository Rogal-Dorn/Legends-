...
this.legend_armor_plate_full <- this.inherit("scripts/items/legend_armor/legend_armor_upgrade", {
	...
	function updateVariant()
	{
		...
		this.m.Icon = "legend_armor/plate/legend_armor_plate_full" + "_" + variant + ".png";
		this.m.IconLarge = this.m.Icon;
		this.m.OverlayIcon = "legend_armor/plate/icon_legend_armor_plate_full" + "_" + variant + ".png";
		this.m.OverlayIconLarge = "legend_armor/plate/inventory_legend_armor_plate_full" + "_" + variant + ".png";
	}
});
