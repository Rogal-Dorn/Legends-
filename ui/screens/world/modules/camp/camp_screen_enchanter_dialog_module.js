...
CampScreenEnchanterDialogModule.prototype.createDIV = function (_parentDiv)
{
    ...
    this.mContainer = $('<div class="l-enchanter-dialog-container display-none opacity-none"/>');
    _parentDiv.append(this.mContainer);
    this.mDialogContainer = this.mContainer.createDialog('Enchant', '', '', true, 'dialog-1024-768');
