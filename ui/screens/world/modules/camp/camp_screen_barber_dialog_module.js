...
var CampScreenBarberDialogModule = function (_parent) {
	this.mSQHandle = null;
...
CampScreenBarberDialogModule.prototype.isConnected = function () {
	return this.mSQHandle !== null;
};

CampScreenBarberDialogModule.prototype.onConnection = function (_handle) {
...
CampScreenBarberDialogModule.prototype.onDisconnection = function () {
	this.mSQHandle = null;
...
CampScreenBarberDialogModule.prototype.createDIV = function (_parentDiv) {
	var self = this;
...
CampScreenBarberDialogModule.prototype.destroyDIV = function () {
...
CampScreenBarberDialogModule.prototype.createAppearanceControlDIV = function (_label, _class, _definition, _parentDiv) {
	var self = this;
...
CampScreenBarberDialogModule.prototype.addListEntry = function (_data) {
	...
	var name = $('<div class="name title-font-normal font-bold font-color-brother-name">' + _data[CampScreenIdentifier.HireRosterEntry.Name] + '</div>');
	row.append(name);
...
CampScreenBarberDialogModule.prototype.selectListEntry = function (_element, _scrollToEntry) {
...
CampScreenBarberDialogModule.prototype.updateDetailsPanel = function (_element) {
	if (_element !== null && _element.length > 0) {
...
CampScreenBarberDialogModule.prototype.create = function (_parentDiv) {
	this.createDIV(_parentDiv);
	this.bindTooltips();
};

CampScreenBarberDialogModule.prototype.destroy = function () {
	this.unbindTooltips();
	this.destroyDIV();
};


CampScreenBarberDialogModule.prototype.register = function (_parentDiv) {
	console.log('CampScreenBarberDialogModule::REGISTER');

	if (this.mContainer !== null) {
		console.error('ERROR: Failed to register Camp TScreen Hire Dialog Module. Reason: Camp Screen Barber Register Dialog Module is already initialized.');
		return;
	}
...
CampScreenBarberDialogModule.prototype.unregister = function () {
	console.log('CampScreenBarberDialogModule::UNREGISTER');

	if (this.mContainer === null) {
		console.error('ERROR: Failed to unregister Camp Screen Barber Dialog Module. Reason: Camp Screen Barber Unregister Dialog Module is not initialized.');
		return;
	}
...
CampScreenBarberDialogModule.prototype.isRegistered = function () {
	if (this.mContainer !== null) {
...
CampScreenBarberDialogModule.prototype.registerEventListener = function (_listener) {
	this.mEventListener = _listener;
};


CampScreenBarberDialogModule.prototype.show = function (_withSlideAnimation) {
	var self = this;
...
CampScreenBarberDialogModule.prototype.hide = function () {
	var self = this;
...
CampScreenBarberDialogModule.prototype.isVisible = function () {
	return this.mIsVisible;
};

CampScreenBarberDialogModule.prototype.updateAssets = function (_data) {
	this.mAssets.loadFromData(_data);
	//this.updateListEntryValues();
}

CampScreenBarberDialogModule.prototype.loadFromData = function (_data) {
...
CampScreenBarberDialogModule.prototype.notifyBackendModuleShown = function () {
	SQ.call(this.mSQHandle, 'onModuleShown');
};

CampScreenBarberDialogModule.prototype.notifyBackendModuleHidden = function () {
	SQ.call(this.mSQHandle, 'onModuleHidden');
};

CampScreenBarberDialogModule.prototype.notifyBackendModuleAnimating = function () {
	SQ.call(this.mSQHandle, 'onModuleAnimating');
};

CampScreenBarberDialogModule.prototype.notifyBackendLeaveButtonPressed = function () {
