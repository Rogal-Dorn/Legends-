...
CampScreenMainDialogModule.prototype.loadFromData = function (_data)
{
	...
	console.error(_data['Background']);
...
CampScreenMainDialogModule.prototype.updateEffects = function (_data)
{
	var content = this.mDialogContainer.findDialogContentContainer();
...
CampScreenMainDialogModule.prototype.createEffect = function (_data, _i, _content)
{
	if (_data == null)
	{
		return;
