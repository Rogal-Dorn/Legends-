...
var CampScreenRecruitDialogModule = function(_parent)
{
	this.mSQHandle = null;
...
CampScreenRecruitDialogModule.prototype.isConnected = function ()
{
	return this.mSQHandle !== null;
};

CampScreenRecruitDialogModule.prototype.onConnection = function (_handle)
{
...
CampScreenRecruitDialogModule.prototype.onDisconnection = function ()
{
	this.mSQHandle = null;
...
CampScreenRecruitDialogModule.prototype.createDIV = function (_parentDiv)
{
	var self = this;
...
CampScreenRecruitDialogModule.prototype.destroyDIV = function ()
{
...
CampScreenRecruitDialogModule.prototype.addListEntry = function (_data)
{
...
CampScreenRecruitDialogModule.prototype.selectListEntry = function(_element, _scrollToEntry)
{
...
CampScreenRecruitDialogModule.prototype.updateDetailsPanel = function(_element)
{
	if (_element !== null && _element.length > 0)
	{
...
CampScreenRecruitDialogModule.prototype.updateListEntryValues = function()
{
	var currentMoney = this.mAssets.getValues().Money;
...
CampScreenRecruitDialogModule.prototype.bindTooltips = function ()
{
...
CampScreenRecruitDialogModule.prototype.unbindTooltips = function ()
{
...
CampScreenRecruitDialogModule.prototype.create = function(_parentDiv)
{
	this.createDIV(_parentDiv);
	this.bindTooltips();
};

CampScreenRecruitDialogModule.prototype.destroy = function()
{
	this.unbindTooltips();
	this.destroyDIV();
};
...
CampScreenRecruitDialogModule.prototype.register = function (_parentDiv)
{
	console.log('CampScreenRecruitDialogModule::REGISTER');

	if (this.mContainer !== null)
	{
		console.error('ERROR: Failed to register Camp Screen Hire Dialog Module. Reason: Camp Screen Hire Dialog Module is already initialized.');
		return;
	}
...
CampScreenRecruitDialogModule.prototype.unregister = function ()
{
	console.log('CampScreenRecruitDialogModule::UNREGISTER');

	if (this.mContainer === null)
	{
		console.error('ERROR: Failed to unregister CampScreen Hire Dialog Module. Reason: Camp Screen Hire Dialog Module is not initialized.');
		return;
	}
...
CampScreenRecruitDialogModule.prototype.isRegistered = function ()
{
	if (this.mContainer !== null)
	{
...
CampScreenRecruitDialogModule.prototype.registerEventListener = function(_listener)
{
	this.mEventListener = _listener;
};


CampScreenRecruitDialogModule.prototype.show = function (_withSlideAnimation)
{
	var self = this;
...
CampScreenRecruitDialogModule.prototype.hide = function ()
{
	var self = this;
...
CampScreenRecruitDialogModule.prototype.isVisible = function ()
{
	return this.mIsVisible;
};


// CampScreenRecruitDialogModule.prototype.onHireInformation = function (_dataSource, _data)
// {
...
CampScreenRecruitDialogModule.prototype.updateAssets = function (_data)
{
	this.mAssets.loadFromData(_data);
	this.updateListEntryValues();
}

CampScreenRecruitDialogModule.prototype.loadFromData = function (_data)
{
...
CampScreenRecruitDialogModule.prototype.removeRosterEntry  = function (_data)
{
	...
	if(entry !== null)
	{
		...
		{
			console.error('ERROR: Failed to update camp hire roster. Invalid entry data.');
		}
	}
};

CampScreenRecruitDialogModule.prototype.dismissRosterEntry = function (_entryID)
{
	var self = this;
	this.notifyBackendDismissRosterEntry(_entryID, function (data)
	{
		...
		if (data.Result != 0)
		{
			...
			{
				console.error("Failed to dismiss at camp. Reason: Unknown");
			}
...
CampScreenRecruitDialogModule.prototype.hireRosterEntry = function (_entryID)
{
	var self = this;
	this.notifyBackendHireRosterEntry(_entryID, function (data)
	{
		...
		if (data.Result != 0)
		{
			...
			{
				console.error("Failed to hire at camp. Reason: Unknown");
			}
...
CampScreenRecruitDialogModule.prototype.tryoutRosterEntry = function (_entryID)
{
	var self = this;
	this.notifyBackendTryoutRosterEntry(_entryID, function (data)
	{
		...
		if (data.Result != 0)
		{
			...
			{
				console.error("Failed to hire tryout at camp. Reason: Unknown");
			}
...
CampScreenRecruitDialogModule.prototype.notifyBackendModuleShown = function ()
{
	SQ.call(this.mSQHandle, 'onModuleShown');
};

CampScreenRecruitDialogModule.prototype.notifyBackendModuleHidden = function ()
{
	SQ.call(this.mSQHandle, 'onModuleHidden');
};

CampScreenRecruitDialogModule.prototype.notifyBackendModuleAnimating = function ()
{
	SQ.call(this.mSQHandle, 'onModuleAnimating');
};

CampScreenRecruitDialogModule.prototype.notifyBackendLeaveButtonPressed = function ()
{
	SQ.call(this.mSQHandle, 'onLeaveButtonPressed');
};

CampScreenRecruitDialogModule.prototype.notifyBackendBrothersButtonPressed = function ()
{
	SQ.call(this.mSQHandle, 'onBrothersButtonPressed');
};

CampScreenRecruitDialogModule.prototype.notifyBackendHireRosterEntry = function (_entryID, _callback)
{
	SQ.call(this.mSQHandle, 'onHireRosterEntry', _entryID, _callback);
};

CampScreenRecruitDialogModule.prototype.notifyBackendDismissRosterEntry = function (_entryID, _callback)
{
	SQ.call(this.mSQHandle, 'onDismissRosterEntry', _entryID, _callback);
};

CampScreenRecruitDialogModule.prototype.notifyBackendTryoutRosterEntry = function (_entryID, _callback)
{
