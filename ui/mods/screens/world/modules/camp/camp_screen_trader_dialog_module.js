...
var CampScreenShop =
{
	ItemOwner:
	{
		Stash: 'camp-screen-shop-dialog-module.stash',
		Shop: 'camp-screen-shop-dialog-module.shop'
	},
...
var CampScreenTraderDialogModule = function(_parent)
{
	this.mSQHandle = null;
...
CampScreenTraderDialogModule.prototype.isConnected = function ()
{
	return this.mSQHandle !== null;
};

CampScreenTraderDialogModule.prototype.onConnection = function (_handle)
{
...
CampScreenTraderDialogModule.prototype.onDisconnection = function ()
{
	this.mSQHandle = null;
...
CampScreenTraderDialogModule.prototype.updateAssets = function (_data)
{
	this.mAssets.loadFromData(_data);
	this.updateItemPriceLabels(this.mShopSlots, this.mShopList, false);
}

CampScreenTraderDialogModule.prototype.createDIV = function (_parentDiv)
{
	var self = this;
...
CampScreenTraderDialogModule.prototype.destroyDIV = function ()
{
	this.mStashSlots = null;
	this.mShopSlots = null;
...
CampScreenTraderDialogModule.prototype.setupEventHandler = function ()
{
	var self = this;
	...
	*/
	...
	var dropHandler = function (ev, dd)
	{
		...
		if(sourceOwner === CampScreenTrader.ItemOwner.Shop && targetOwner === CampScreenTrader.ItemOwner.Shop)
		{
	...
	this.mStashListContainer.data('item', { owner: CampScreenTrader.ItemOwner.Stash });
	...
	this.mShopListContainer.data('item', { owner: CampScreenTrader.ItemOwner.Shop });
...
CampScreenTraderDialogModule.prototype.unbindTooltips = function ()
{
...
CampScreenTraderDialogModule.prototype.create = function(_parentDiv)
{
	this.createDIV(_parentDiv);
	this.bindTooltips();
};

CampScreenTraderDialogModule.prototype.destroy = function()
{
	this.unbindTooltips();
	this.destroyDIV();
};

CampScreenTraderDialogModule.prototype.register = function (_parentDiv)
{
	console.log('CampScreenTraderDialogModule::REGISTER');

	if (this.mContainer !== null)
	{
		console.error('ERROR: Failed to register Camp Screen Trader Dialog Module. Reason: Camp Screen Trader Dialog Module is already initialized.');
		return;
	}
...
CampScreenTraderDialogModule.prototype.unregister = function ()
{
	console.log('CampScreenTraderDialogModule::UNREGISTER');

	if (this.mContainer === null)
	{
		console.error('ERROR: Failed to unregister Camp Screen Shop Dialog Module. Reason: Camp Screen Shop Dialog Module is not initialized.');
		return;
	}
...
CampScreenTraderDialogModule.prototype.isRegistered = function ()
{
	if (this.mContainer !== null)
	{
...
CampScreenTraderDialogModule.prototype.registerEventListener = function(_listener)
{
	this.mEventListener = _listener;
};


/*CampScreenTraderDialogModule.prototype.show = function (_withSlideAnimation)
{
	var self = this;
...
CampScreenTraderDialogModule.prototype.hide = function ()
{
	var self = this;
...
CampScreenTraderDialogModule.prototype.isVisible = function ()
{
	return this.mIsVisible;
};

CampScreenTraderDialogModule.prototype.loadFromData = function (_data)
{
...
CampScreenTraderDialogModule.prototype.loadStashData = function (_data)
{
	...
	this.assignItems(CampScreenTrader.ItemOwner.Stash, _data, arrayRef.val, containerRef.val);
};

CampScreenTraderDialogModule.prototype.loadShopData = function (_data)
{
	if(_data === undefined || _data === null || !jQuery.isArray(_data))
	{
		return;
	...
	this.assignItems(CampScreenTrader.ItemOwner.Shop, _data, arrayRef.val, containerRef.val);
};

CampScreenTraderDialogModule.prototype.assignItems = function (_owner, _items, _itemArray, _itemContainer)
{
	...
	if(_items.length > 0)
	{
		...
		this.updateItemPriceLabels(_itemArray, _items, _owner === CampScreenTrader.ItemOwner.Stash);

		if(_owner === CampScreenTrader.ItemOwner.Stash)
		{
...
CampScreenTraderDialogModule.prototype.removeItemFromSlot = function(_slot)
{
	// remove item image
...
CampScreenTraderDialogModule.prototype.assignItemToSlot = function(_owner, _slot, _item)
{
	var remove = false;
...
CampScreenTraderDialogModule.prototype.querySlotByIndex = function(_itemArray, _index)
{
...
CampScreenTraderDialogModule.prototype.createItemSlots = function (_owner, _size, _itemArray, _itemContainer)
{
...
CampScreenTraderDialogModule.prototype.clearItemSlots = function (_itemArray)
{
...
CampScreenTraderDialogModule.prototype.createItemSlot = function (_owner, _index, _parentDiv, _screenDiv)
{
	var self = this;
	...
	var dragEndHandler = function (_source, _target)
	{
		...
		if(sourceOwner === CampScreenTrader.ItemOwner.Shop)
		{
	...
	result.assignListItemDragAndDrop(_screenDiv, null, dragEndHandler, _owner === CampScreenTrader.ItemOwner.Stash ? dropHandler : null);
	...
	result.assignListItemRightClick(function (_item, _event)
	{
		...
		if(/*doSomething &&*/ isEmpty === false && owner !== null /*&& itemId !== null*/ && itemIdx !== null)
		{
			...
			switch(owner)
			{
				case CampScreenTrader.ItemOwner.Stash:
				{
					if (repairItem === true)
					{
					...
					{
						//console.info('sell');
						self.swapItem(itemIdx, owner, null, CampScreenTrader.ItemOwner.Shop);
					}
				} break;
				case CampScreenTrader.ItemOwner.Shop:
				{
					if (destroyItem !== true)
					{
						//console.info('buy');
						/*if(*/self.swapItem(itemIdx, owner, null, CampScreenTrader.ItemOwner.Stash);//))
// 						{
...
CampScreenTraderDialogModule.prototype.repairItem = function(_itemIdx)
{
	var self = this;
	this.notifyBackendRepairItem(_itemIdx, function(_result)
	{
		...
		{
			self.updateSlotItem(CampScreenTrader.ItemOwner.Stash, self.mStashSlots, _result.Item, _itemIdx, CampScreenTrader.ItemFlag.Updated);
		}
...
CampScreenTraderDialogModule.prototype.swapItem = function (_sourceItemIdx, _sourceItemOwner, _targetItemIdx, _targetItemOwner)
{
	var self = this;
...
CampScreenTraderDialogModule.prototype.updateStashList = function (_data)
{
	...
	for(var i = 0; i < this.mStashList.length; ++i)
	{
		...
		if(sourceItem === null && targetItem !== null)
		{
			if('id' in targetItem)
			{
				...
				this.updateSlotItem(CampScreenTrader.ItemOwner.Stash, this.mStashSlots, targetItem, i, CampScreenTrader.ItemFlag.Inserted);
			}
		}
		...
		else if(sourceItem !== null && targetItem === null)
		{
			...
			this.mStashList[i] = targetItem;
			this.updateSlotItem(CampScreenTrader.ItemOwner.Stash, this.mStashSlots, targetItem, i, CampScreenTrader.ItemFlag.Removed);
		}
		...
		else
		{
			if((sourceItem !== null && targetItem !== null) && ('id' in sourceItem && 'id' in targetItem) && (sourceItem.id !== targetItem.id))
			{
				...
				this.mStashList[i] = targetItem;
				this.updateSlotItem(CampScreenTrader.ItemOwner.Stash, this.mStashSlots, targetItem, i, CampScreenTrader.ItemFlag.Updated);
			}
		}
	}
};

CampScreenTraderDialogModule.prototype.updateShopList = function (_data)
{
...
//	 }
	...
	{
		this.createItemSlots(CampScreenTrader.ItemOwner.Shop, _data.length - this.mShopSlots.length, this.mShopSlots, this.mShopListScrollContainer);
	}
	...
	for(var i = 0; i < maxLength; ++i)
	{
		...
		if(i >= this.mShopList.length || (oldItem === null && newItem !== null))
		{
			...
			this.updateSlotItem(CampScreenTrader.ItemOwner.Shop, this.mShopSlots, newItem, i, CampScreenTrader.ItemFlag.Inserted);
		}
		...
		else if(i >= _data.length || (oldItem !== null && newItem === null))
		{
			...
			this.updateSlotItem(CampScreenTrader.ItemOwner.Shop, this.mShopSlots, oldItem, i, CampScreenTrader.ItemFlag.Removed);
		}
		...
		else
		{
			if((oldItem !== null && newItem !== null) && ('id' in oldItem && 'id' in newItem))
			{
				if(oldItem.id !== newItem.id)
				{
					...
					this.updateSlotItem(CampScreenTrader.ItemOwner.Shop, this.mShopSlots, newItem, i, CampScreenTrader.ItemFlag.Updated);
				}
				else
				{
...
CampScreenTraderDialogModule.prototype.updateItemPriceLabel = function (_slot, _item, _positiveColor)
{
...
CampScreenTraderDialogModule.prototype.updateItemPriceLabels = function (_itemArray, _items, _allPositiveColors)
{
...
CampScreenTraderDialogModule.prototype.updateSlotItem = function (_owner, _itemArray, _item, _index, _flag)
{
	...
	switch(_flag)
	{
		case CampScreenTrader.ItemFlag.Inserted:
		case CampScreenTrader.ItemFlag.Updated:
		{
			this.removeItemFromSlot(slot);
			this.assignItemToSlot(_owner, slot, _item);
			this.updateItemPriceLabel(slot, _item, _owner === CampScreenTrader.ItemOwner.Stash);
			break;
		}
		case CampScreenTrader.ItemFlag.Removed:
		{
			this.removeItemFromSlot(slot);
			break;
		} 
...
CampScreenTraderDialogModule.prototype.updateStashFreeSlotsLabel = function ()
{
...
CampScreenTraderDialogModule.prototype.hasEnoughMoneyToBuy = function (_itemIdx)
{
...
CampScreenTraderDialogModule.prototype.isStashSpaceLeft = function ()
{
	for(var i = 0; i < this.mStashList.length; ++i)
	{
...
CampScreenTraderDialogModule.prototype.getStashStatistics = function ()
{
	/*var usedSpace = 0;
...
CampScreenTraderDialogModule.prototype.notifyBackendModuleShown = function ()
{
	SQ.call(this.mSQHandle, 'onModuleShown');
};

CampScreenTraderDialogModule.prototype.notifyBackendModuleHidden = function ()
{
	SQ.call(this.mSQHandle, 'onModuleHidden');
};

CampScreenTraderDialogModule.prototype.notifyBackendModuleAnimating = function ()
{
	SQ.call(this.mSQHandle, 'onModuleAnimating');
};

CampScreenTraderDialogModule.prototype.notifyBackendLeaveButtonPressed = function ()
{
	SQ.call(this.mSQHandle, 'onLeaveButtonPressed');
};

CampScreenTraderDialogModule.prototype.notifyBackendRepairItem = function (_itemIdx, _callback)
{
	SQ.call(this.mSQHandle, 'onRepairItem', _itemIdx, _callback);
};


CampScreenTraderDialogModule.prototype.notifyBackendSwapItem = function (_sourceItemIdx, _sourceItemOwner, _targetItemIdx, _targetItemOwner, _callback)
{
	SQ.call(this.mSQHandle, 'onSwapItem', [_sourceItemIdx, _sourceItemOwner, _targetItemIdx, _targetItemOwner], _callback);
};


CampScreenTraderDialogModule.prototype.notifyBackendSortButtonClicked = function () 
{
	SQ.call(this.mSQHandle, 'onSortButtonClicked');
}

CampScreenTraderDialogModule.prototype.notifyBackendFilterAllButtonClicked = function ()
{
	SQ.call(this.mSQHandle, 'onFilterAll');
};

CampScreenTraderDialogModule.prototype.notifyBackendFilterWeaponsButtonClicked = function ()
{
	SQ.call(this.mSQHandle, 'onFilterWeapons');
};

CampScreenTraderDialogModule.prototype.notifyBackendFilterArmorButtonClicked = function ()
{
	SQ.call(this.mSQHandle, 'onFilterArmor');
};

CampScreenTraderDialogModule.prototype.notifyBackendFilterMiscButtonClicked = function ()
{
	SQ.call(this.mSQHandle, 'onFilterMisc');
};

CampScreenTraderDialogModule.prototype.notifyBackendFilterUsableButtonClicked = function ()
{
