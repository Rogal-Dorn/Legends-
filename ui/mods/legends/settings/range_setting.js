...
class RangeSetting {
    ...
    constructor(mod, page, setting, parentDiv) {
        ...
        this.layout = $('<div class="setting-box range-box"/>');
...
let setting = {
    name: 'Example Range Setting',
    id: 'exampleRangeSetting',
    value: 10.123456,
    min: 0,
    max: 100,
    step: 0.01,
...
let rangeSetting = new RangeSetting(mod, page, setting, parentDiv);
