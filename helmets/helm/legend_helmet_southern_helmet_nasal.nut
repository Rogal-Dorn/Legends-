...
this.legend_helmet_southern_helmet_nasal <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function updateVariant()
	{
		...
		this.m.Sprite = "legendhelms_southern_helmet_nasal" + "_" + variant;
		this.m.SpriteDamaged = "legendhelms_southern_helmet_nasal" + "_" + variant + "_damaged";
		this.m.SpriteCorpse = "legendhelms_southern_helmet_nasal" + "_" + variant + "_dead";
		this.m.Icon = "legend_helmets/inventory_southern_helmet_nasal" + "_" + variant + ".png";
