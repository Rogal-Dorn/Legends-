...
this.legend_helmet_barb_ritual_helm <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Northern Ritual Helmet";
	...
	function updateVariant()
	{
		...
		this.m.Sprite = "legendhelms_barb_ritual_helm" + "_" + variant;
		this.m.SpriteDamaged = "legendhelms_barb_ritual_helm" + "_" + variant + "_damaged";
		this.m.SpriteCorpse = "legendhelms_barb_ritual_helm" + "_" + variant + "_dead";
		this.m.Icon = "legend_helmets/inventory_barb_ritual_helm" + "_" + variant + ".png";
