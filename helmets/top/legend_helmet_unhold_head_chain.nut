...
this.legend_helmet_unhold_head_chain <- this.inherit("scripts/items/legend_helmets/legend_helmet_upgrade", {
	...
	function updateVariant()
	{
		...
		this.m.Sprite = "legendhelms_unhold_head_chain" + "_" + variant;
		this.m.SpriteDamaged = "legendhelms_unhold_head_chain" + "_" + variant + "_damaged";
		this.m.SpriteCorpse = "legendhelms_unhold_head_chain" + "_" + variant + "_dead";
		this.m.Icon = "legend_helmets/inventory_unhold_head_chain" + "_" + variant + ".png";
