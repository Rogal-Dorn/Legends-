...
this.legend_helmet_bascinet_visor_named <- this.inherit("scripts/items/legend_helmets/legend_named_helmet_upgrade", {
	...
	function create()
	{
		...
		this.m.Name = "Pointed Visor";
        this.m.NameList = this.Const.Strings.LegendArmorLayers;
		this.m.Description = "A gilded visor with a pointed snout and plenty of holes to breath through.";
	...
	function randomizeValues()
	{
		...
		this.m.StaminaModifier = this.Math.rand(-4, -2);
		this.m.Condition = this.Math.rand(80, 105);
